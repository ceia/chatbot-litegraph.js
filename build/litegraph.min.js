...
(function(v) {
  ...
  function x(a, b) {
    ...
    g = b.left || 0;
    a = b.top || 0;
    b.event && (g = b.event.clientX - 10, a = b.event.clientY - 10, b.title && (a -= 20), b.parentMenu && (g = b.parentMenu.root.getBoundingClientRect(), g = g.left + g.width), c = document.body.getBoundingClientRect(), F = f.getBoundingClientRect(), 0 == c.height && console.error("document.body height is 0. That is dangerous, set html,body { height: 100%; }"), c.width && g > c.width - F.width - 10 && (g = c.width - F.width - 10), c.height && a > c.height - F.height - 10 && (a = c.height - F.height - 
    10));
    f.style.left = g + "px";
    f.style.top = a + "px";
  ...
  ON_EVENT:1, NEVER:2, ON_TRIGGER:3, UP:1, DOWN:2, LEFT:3, RIGHT:4, CENTER:5, STRAIGHT_LINK:0, LINEAR_LINK:1, SPLINE_LINK:2, NORMAL_TITLE:0, NO_TITLE:1, TRANSPARENT_TITLE:2, AUTOHIDE_TITLE:3, proxy:null, node_images_path:"", debug:!1, catch_exceptions:!0, throw_errors:!0, allow_scripts:!1, registered_node_types:{}, node_types_by_file_extension:{}, Nodes:{}, Globals:{}, searchbox_extras:{}, registerNodeType:function(a, b) {
    ...
    for (var w = Array(b.length), c = "", F = f.getParameterNames(b), k = 0; k < F.length; ++k) {
      c += "this.addInput('" + F[k] + "'," + (d && d[k] ? "'" + d[k] + "'" : "0") + ");\n";
    }
  ...
  c.prototype.computeExecutionOrder = function(a, b) {
    for (var d = [], e = [], g = {}, w = {}, c = {}, k = 0, p = this._nodes.length; k < p; ++k) {
      ...
      if (!a || n.onExecute) {
        ...
        var l = 0;
        if (n.inputs) {
          for (var u = 0, z = n.inputs.length; u < z; u++) {
        ...
        for (k = 0; k < n.outputs.length; k++) {
          if (a = n.outputs[k], null != a && null != a.links && 0 != a.links.length) {
            for (u = 0; u < a.links.length; u++) {
              (p = this.links[a.links[u]]) && !w[p.id] && (l = this.getNodeById(p.target_id), null == l ? w[p.id] = !0 : (b && (!l._level || l._level <= n._level) && (l._level = n._level + 1), w[p.id] = !0, --c[l.id], 0 == c[l.id] && e.push(l)));
            }
          }
        }
      }
    ...
    if (a) {
      ...
      if (b) {
        ...
        for (g = b.length; e < g; ++e) {
          ...
          c || (f.debug && console.log("Node not found or has errors: " + w.type), c = new m, c.last_serialization = w, d = c.has_errors = !0);
          c.id = w.id;
          this.add(c, !0);
        }
        e = 0;
  ...
  m.prototype.addProperty = function(a, b, d, e) {
  ...
  m.prototype.addConnection = function(a, b, d, e) {
  ...
  m.prototype.computeSize = function(a) {
    ...
    d = Math.max(d, 1);
    var e = f.NODE_TEXT_SIZE, g = b(this.title), c = 0, k = 0;
    if (this.inputs) {
    ...
    if (this.widgets && this.widgets.length) {
      ...
      for (n = this.widgets.length; p < n; ++p) {
        d = this.widgets[p].computeSize ? d + (this.widgets[p].computeSize(a[0])[1] + 4) : d + (f.NODE_WIDGET_HEIGHT + 4);
      }
      d += 8;
    }
  ...
  m.prototype.addWidget = function(a, b, d, e, g) {
  ...
  m.prototype.isPointInside = function(a, b, d, e) {
    d = d || 0;
    var g = this.graph && this.graph.isLive() ? 0 : f.NODE_TITLE_HEIGHT;
    e && (g = 0);
    if (this.flags && this.flags.collapsed) {
      if (y(a, b, this.pos[0] - d, this.pos[1] - f.NODE_TITLE_HEIGHT - d, (this._collapsed_width || f.NODE_COLLAPSED_WIDTH) + 2 * d, f.NODE_TITLE_HEIGHT + 2 * d)) {
        return !0;
      }
    } else {
  ...
  m.prototype.getSlotInPosition = function(a, b) {
    ...
    if (this.outputs) {
      for (e = 0, g = this.outputs.length; e < g; ++e) {
        if (f = this.outputs[e], this.getConnectionPos(!1, e, d), y(a, b, d[0] - 10, d[1] - 5, 20, 10)) {
  ...
  m.prototype.connect = function(a, b, d) {
    ...
    var c = b.inputs[d], k = null;
    if (!f.isValidConnection(g.type, c.type)) {
      return this.setDirtyCanvas(!1, !0), e && this.graph.connectionChange(this, k), null;
    }
    e || this.graph.beforeChange();
    k = new q(++this.graph.last_link_id, c.type, this.id, a, b.id, d);
    this.graph.links[k.id] = k;
    null == g.links && (g.links = []);
    g.links.push(k.id);
    b.inputs[d].link = k.id;
    this.graph && this.graph._version++;
    if (this.onConnectionsChange) {
      this.onConnectionsChange(f.OUTPUT, a, !0, k, g);
    }
    if (b.onConnectionsChange) {
      b.onConnectionsChange(f.INPUT, d, !0, k, c);
    }
  ...
  m.prototype.disconnectOutput = function(a, b) {
    ...
    if (b) {
      ...
      for (var e = 0, g = d.links.length; e < g; e++) {
        var c = d.links[e], k = this.graph.links[c];
        if (k.target_id == b.id) {
          d.links.splice(e, 1);
          ...
          this.graph && this.graph._version++;
          if (b.onConnectionsChange) {
            b.onConnectionsChange(f.INPUT, k.target_slot, !1, k, p);
          }
          if (this.onConnectionsChange) {
            this.onConnectionsChange(f.OUTPUT, a, !1, k, d);
          }
          if (this.graph && this.graph.onNodeConnectionChange) {
            this.graph.onNodeConnectionChange(f.OUTPUT, this, a);
          }
          this.graph && this.graph.onNodeConnectionChange && (this.graph.onNodeConnectionChange(f.OUTPUT, this, a), this.graph.onNodeConnectionChange(f.INPUT, b, k.target_slot));
          break;
        }
      }
    } else {
      ...
      for (g = d.links.length; e < g; e++) {
        if (c = d.links[e], k = this.graph.links[c]) {
          ...
          if (b) {
            ...
            if (this.graph && this.graph.onNodeConnectionChange) {
              this.graph.onNodeConnectionChange(f.INPUT, b, k.target_slot);
            }
          }
          delete this.graph.links[c];
          if (this.onConnectionsChange) {
  ...
  m.prototype.disconnectInput = function(a) {
    ...
    if (null != d) {
      ...
      if (e) {
        ...
        for (var k = 0, p = c.links.length; k < p; k++) {
          if (c.links[k] == d) {
            c.links.splice(k, 1);
            break;
          }
        ...
        if (g.onConnectionsChange) {
          g.onConnectionsChange(f.OUTPUT, k, !1, e, c);
        }
        this.graph && this.graph.onNodeConnectionChange && (this.graph.onNodeConnectionChange(f.OUTPUT, g, k), this.graph.onNodeConnectionChange(f.INPUT, this, a));
      }
    }
    this.setDirtyCanvas(!1, !0);
  ...
  v.LGraphCanvas = f.LGraphCanvas = l;
        ...
        if (1 == a.which) {
          ...
          if (e && this.allow_interaction && !g && !this.read_only) {
            ...
            if (!this.connecting_node && !e.flags.collapsed && !this.live_mode) {
              if (!g && !1 !== e.resizable && y(a.canvasX, a.canvasY, e.pos[0] + e.size[0] - 5, e.pos[1] + e.size[1] - 5, 10, 10)) {
                this.graph.beforeChange(), this.resizing_node = e, this.canvas.style.cursor = "se-resize", g = !0;
              } else {
                if (e.outputs) {
                  for (var p = 0, n = e.outputs.length; p < n; ++p) {
                    var h = e.outputs[p], m = e.getConnectionPos(!1, p);
                    if (y(a.canvasX, a.canvasY, m[0] - 15, m[1] - 10, 30, 20)) {
                      this.connecting_node = e;
                      this.connecting_output = h;
                      this.connecting_pos = e.getConnectionPos(!1, p);
                      this.connecting_slot = p;
                      a.shiftKey && e.disconnectOutput(p);
                      if (c) {
                ...
                if (e.inputs) {
                  for (p = 0, n = e.inputs.length; p < n; ++p) {
                    if (h = e.inputs[p], m = e.getConnectionPos(!0, p), y(a.canvasX, a.canvasY, m[0] - 15, m[1] - 10, 30, 20)) {
                      if (c) {
            ...
            if (!g) {
              ...
              e.onMouseDown && e.onMouseDown(a, n, this) ? p = !0 : (e.subgraph && !e.skip_subgraph_button && !e.flags.collapsed && n[0] > e.size[0] - f.NODE_TITLE_HEIGHT && 0 > n[1] && (d = this, setTimeout(function() {
                d.openSubgraph(e.subgraph);
              }, 10)), this.live_mode && (p = k = !0));
              p || (this.allow_dragnodes && (this.graph.beforeChange(), this.node_dragged = e), this.selected_nodes[e.id] || this.processNodeSelected(e, a));
              this.dirty_canvas = !0;
            }
          } else {
            if (!this.read_only) {
              for (p = 0; p < this.visible_links.length; ++p) {
                if (k = this.visible_links[p], n = k._pos, !(!n || a.canvasX < n[0] - 4 || a.canvasX > n[0] + 4 || a.canvasY < n[1] - 4 || a.canvasY > n[1] + 4)) {
          ...
          !g && k && this.allow_dragcanvas && (this.dragging_canvas = !0);
        } else {
          ...
          if (this.dragging_canvas) {
            ...
            if (this.allow_interaction && !this.read_only) {
              ...
              if (e) {
                ...
                this.canvas && (y(a.canvasX, a.canvasY, e.pos[0] + e.size[0] - 5, e.pos[1] + e.size[1] - 5, 5, 5) ? this.canvas.style.cursor = "se-resize" : this.canvas.style.cursor = "crosshair");
              } else {
                g = null;
          ...
          if (this.connecting_node) {
            ...
            if (this.resizing_node) {
              ...
              if (this.node_dragged) {
                (e = this.node_dragged) && 300 > a.click_time && y(a.canvasX, a.canvasY, e.pos[0], e.pos[1] - f.NODE_TITLE_HEIGHT, f.NODE_TITLE_HEIGHT, f.NODE_TITLE_HEIGHT) && e.collapse();
                this.dirty_bgcanvas = this.dirty_canvas = !0;
  ...
  l.prototype.isOverNodeBox = function(a, b, d) {
    ...
    return y(b, d, a.pos[0] + 2, a.pos[1] + 2 - e, e - 4, e - 4) ? !0 : !1;
  };
  ...
  l.prototype.drawButton = function(a, b, d, e, g, c, k, p) {
    ...
    var n = this.mouse, l = f.isInsideRectangle(n[0], n[1], a, b, d, e);
    n = (n = this.last_click_position) && f.isInsideRectangle(n[0], n[1], a, b, d, e);
    w.fillStyle = l ? k : c;
    n && (w.fillStyle = "#AAA");
    w.beginPath();
    ...
    if (this.live_mode) {
      ...
      if (!a.flags.collapsed || !a.onDrawCollapsed || 1 != a.onDrawCollapsed(b, this)) {
        ...
        if (a.flags.collapsed) {
          ...
          null != n && (a._collapsed_width = Math.min(a.size[0], b.measureText(n).width + 2 * f.NODE_TITLE_HEIGHT), C[0] = a._collapsed_width, C[1] = 0);
        }
        ...
        a.has_errors && (e = "red");
        this.drawNodeShape(a, b, C, d, e, a.is_selected, a.mouseOver);
        ...
        if (!a.flags.collapsed) {
          if (a.inputs) {
            for (d = 0; d < a.inputs.length; d++) {
              ...
              b.fill();
              if (e) {
                var z = null != m.label ? m.label : m.name;
                z && (b.fillStyle = f.NODE_TEXT_COLOR, p || m.dir == f.UP ? b.fillText(z, u[0], u[1] - 10) : b.fillText(z, u[0] + 10, u[1] + 5));
              }
            }
          }
          ...
          if (a.outputs) {
            for (d = 0; d < a.outputs.length; d++) {
              ...
              m.shape === f.ARROW_SHAPE ? (b.moveTo(u[0] + 8, u[1] + 0.5), b.lineTo(u[0] - 4, u[1] + 6 + 0.5), b.lineTo(u[0] - 4, u[1] - 6 + 0.5), b.closePath()) : g ? b.rect(u[0] - 4, u[1] - 4, 8, 8) : b.arc(u[0], u[1], 6, 0, 2 * Math.PI), b.fill(), g || b.stroke(), e && (z = null != m.label ? m.label : m.name)) {
                b.fillStyle = f.NODE_TEXT_COLOR, p || m.dir == f.DOWN ? b.fillText(z, u[0], u[1] - 8) : b.fillText(z, u[0] - 10, u[1] + 5);
              }
            }
          }
          b.textAlign = "left";
  ...
  l.prototype.drawNodeShape = function(a, b, d, e, g, c, k) {
    ...
    var p = 0.5 > this.ds.scale, w = a._shape || a.constructor.shape || f.ROUND_SHAPE, n = a.constructor.title_mode, G = !0;
    n == f.TRANSPARENT_TITLE ? G = !1 : n == f.AUTOHIDE_TITLE && k && (G = !0);
    t[0] = 0;
    t[1] = G ? -g : 0;
    t[2] = d[0] + 1;
    t[3] = G ? d[1] + g : d[1];
    ...
    if (G || n == f.TRANSPARENT_TITLE) {
      ...
      if (a.onDrawTitleBox) {
        ...
        if (w == f.ROUND_SHAPE || w == f.CIRCLE_SHAPE || w == f.CARD_SHAPE) {
          if (p && (b.fillStyle = "black", b.beginPath(), b.arc(0.5 * g, -0.5 * g, 6, 0, 2 * Math.PI), b.fill()), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, p) {
            b.fillRect(0.5 * g - 5, -0.5 * g - 5, 10, 10);
          } else {
            b.beginPath();
            G = Math.sqrt(3) / 2 * z;
            var z = 5;
            b.translate(0.5 * g, -0.5 * g);
            b.moveTo(0, -G / 2);
            b.lineTo(-z / 2, G / 2);
            b.lineTo(z / 2, G / 2);
            b.lineTo(0, -G / 2);
          ...
          p && (b.fillStyle = "black", b.fillRect(0.5 * (g - 10) - 1, -0.5 * (g + 10) - 1, 12, 12)), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, b.fillRect(0.5 * (g - 10), -0.5 * (g + 10), 10, 10);
        }
      }
      b.globalAlpha = k;
      ...
      !p && (b.font = this.title_text_font, z = String(a.getTitle())) && (b.fillStyle = c ? f.NODE_SELECTED_TITLE_COLOR : a.constructor.title_text_color || this.node_title_color, a.flags.collapsed ? (b.textAlign = "left", b.measureText(z), b.fillText(z.substr(0, 20), g, f.NODE_TITLE_TEXT_Y - g), b.textAlign = "left") : (b.textAlign = "left", b.fillText(z, g, f.NODE_TITLE_TEXT_Y - g)));
      a.flags.collapsed || !a.subgraph || a.skip_subgraph_button || (z = f.NODE_TITLE_HEIGHT, k = a.size[0] - z, G = f.isInsideRectangle(this.graph_mouse[0] - a.pos[0], this.graph_mouse[1] - a.pos[1], k + 2, -z + 2, z - 4, z - 4), b.fillStyle = G ? "#888" : "#555", w == f.BOX_SHAPE || p ? b.fillRect(k + 2, -z + 2, z - 4, z - 4) : (b.beginPath(), b.roundRect(k + 2, -z + 2, z - 4, z - 4, 4), b.fill()), b.fillStyle = "#333", b.beginPath(), b.moveTo(k + 0.2 * z, 0.6 * -z), b.lineTo(k + 0.8 * z, 0.6 * 
      -z), b.lineTo(k + 0.5 * z, 0.3 * -z), b.fill());
      if (a.onDrawTitle) {
        a.onDrawTitle(b);
      }
    }
      ...
      if (c.inputs && c.inputs.length) {
        for (var l = 0; l < c.inputs.length; ++l) {
          ...
          if (m && null != m.link && (m = this.graph.links[m.link])) {
            var h = this.graph.getNodeById(m.origin_id);
            if (null != h) {
              var r = m.origin_slot;
              var q = -1 == r ? [h.pos[0] + 10, h.pos[1] + 10] : h.getConnectionPos(!1, r, n);
              var u = c.getConnectionPos(!0, l, k);
              p[0] = q[0];
              p[1] = q[1];
              p[2] = u[0] - q[0];
              p[3] = u[1] - q[1];
              ...
              if (A(p, H)) {
                var z = h.outputs[r];
                r = c.inputs[l];
                if (z && r && (h = z.dir || (h.horizontal ? f.DOWN : f.RIGHT), r = r.dir || (c.horizontal ? f.UP : f.LEFT), this.renderLink(a, q, u, m, !1, 0, null, h, r), m && m._last_time && 1000 > b - m._last_time)) {
                  z = 2.0 - 0.002 * (b - m._last_time);
                  var T = a.globalAlpha;
                  a.globalAlpha = T * z;
                  this.renderLink(a, q, u, m, !0, z, "white", h, r);
                  a.globalAlpha = T;
                }
              }
            }
  ...
  l.prototype.renderLink = function(a, b, d, e, g, c, k, p, n, m) {
    ...
    for (var G = 0; G < m; G += 1) {
      ...
      if (this.links_render_mode == f.SPLINE_LINK) {
        ...
        a.bezierCurveTo(b[0] + h, b[1] + F + z, d[0] + r, d[1] + q + z, d[0], d[1] + z);
      } else {
        if (this.links_render_mode == f.LINEAR_LINK) {
          ...
          a.lineTo(b[0] + 15 * h, b[1] + 15 * F + z);
          a.lineTo(d[0] + 15 * r, d[1] + 15 * q + z);
          a.lineTo(d[0], d[1] + z);
        } else {
          if (this.links_render_mode == f.STRAIGHT_LINK) {
            a.moveTo(b[0], b[1]), z = b[0], h = b[1], F = d[0], r = d[1], p == f.RIGHT ? z += 10 : h += 10, n == f.LEFT ? F -= 10 : r -= 10, a.lineTo(z, h), a.lineTo(0.5 * (z + F), h), a.lineTo(0.5 * (z + F), r), a.lineTo(F, r), a.lineTo(d[0], d[1]);
          } else {
            return;
          }
        }
    ...
    0.6 <= this.ds.scale && this.highquality_render && n != f.CENTER && this.render_connection_arrows && (G = this.computeConnectionPoint(b, d, 0.25, p, n), m = this.computeConnectionPoint(b, d, 0.26, p, n), e = this.computeConnectionPoint(b, d, 0.75, p, n), g = this.computeConnectionPoint(b, d, 0.76, p, n), this.render_curved_connections ? (m = -Math.atan2(m[0] - G[0], m[1] - G[1]), g = -Math.atan2(g[0] - e[0], g[1] - e[1])) : g = m = d[1] > b[1] ? 0 : Math.PI, a.save(), a.translate(G[0], G[1]), 
    ...
    if (c) {
      for (a.fillStyle = k, G = 0; 5 > G; ++G) {
        c = (0.001 * f.getTime() + 0.2 * G) % 1, g = this.computeConnectionPoint(b, d, c, p, n), a.beginPath(), a.arc(g[0], g[1], 5, 0, 2 * Math.PI), a.fill();
      }
    }
  };
  ...
  l.prototype.drawNodeWidgets = function(a, b, d, e) {
    ...
    for (var n = f.WIDGET_OUTLINE_COLOR, l = f.WIDGET_BGCOLOR, m = f.WIDGET_TEXT_COLOR, h = f.WIDGET_SECONDARY_TEXT_COLOR, z = 0; z < c.length; ++z) {
      var r = c[z], q = b;
      r.y && (q = r.y);
      r.last_y = q;
      d.strokeStyle = n;
      ...
      switch(r.type) {
        case "button":
          ...
          d.fillRect(36, q, t - 72, k);
          p && !r.disabled && d.strokeRect(18, q, t - 36, k);
          p && (d.textAlign = "center", d.fillStyle = m, d.fillText(r.name, 0.5 * t, q + 0.7 * k));
          break;
        case "toggle":
          d.textAlign = "left";
          d.strokeStyle = n;
          d.fillStyle = l;
          d.beginPath();
          p ? d.roundRect(18, b, t - 36, k, 0.5 * k) : d.rect(18, b, t - 36, k);
          d.fill();
          p && !r.disabled && d.stroke();
          d.fillStyle = r.value ? "#89A" : "#333";
          d.beginPath();
          d.arc(t - 36, q + 0.5 * k, 0.36 * k, 0, 2 * Math.PI);
          d.fill();
          p && (d.fillStyle = h, null != r.name && d.fillText(r.name, 36, q + 0.7 * k), d.fillStyle = r.value ? m : h, d.textAlign = "right", d.fillText(r.value ? r.options.on || "true" : r.options.off || "false", t - 40, q + 0.7 * k));
          break;
        case "slider":
          d.fillStyle = l;
          d.fillRect(18, q, t - 36, k);
          var E = r.options.max - r.options.min, B = (r.value - r.options.min) / E;
          d.fillStyle = e == r ? "#89A" : "#678";
          d.fillRect(18, q, B * (t - 36), k);
          p && !r.disabled && d.strokeRect(18, q, t - 36, k);
          r.marker && (E = (r.marker - r.options.min) / E, d.fillStyle = "#AA9", d.fillRect(18 + E * (t - 36), q, 2, k));
          p && (d.textAlign = "center", d.fillStyle = m, d.fillText(r.name + "  " + Number(r.value).toFixed(3), 0.5 * t, q + 0.7 * k));
          break;
        case "number":
        case "combo":
          d.textAlign = "left";
          ...
          p ? d.roundRect(18, b, t - 36, k, 0.5 * k) : d.rect(18, b, t - 36, k);
          d.fill();
          p && (r.disabled || d.stroke(), d.fillStyle = m, r.disabled || (d.beginPath(), d.moveTo(34, b + 5), d.lineTo(24, b + 0.5 * k), d.lineTo(34, b + k - 5), d.fill(), d.beginPath(), d.moveTo(t - 18 - 16, b + 5), d.lineTo(t - 18 - 6, b + 0.5 * k), d.lineTo(t - 18 - 16, b + k - 5), d.fill()), d.fillStyle = h, d.fillText(r.name, 41, q + 0.7 * k), d.fillStyle = m, d.textAlign = "right", "number" == r.type ? d.fillText(Number(r.value).toFixed(void 0 !== r.options.precision ? r.options.precision : 
          3), t - 36 - 20, q + 0.7 * k) : (E = r.value, r.options.values && (B = r.options.values, B.constructor === Function && (B = B()), B && B.constructor !== Array && (E = B[r.value])), d.fillText(E, t - 36 - 20, q + 0.7 * k)));
          break;
        case "string":
        case "text":
          d.textAlign = "left";
          ...
          p ? d.roundRect(18, b, t - 36, k, 0.5 * k) : d.rect(18, b, t - 36, k);
          d.fill();
          p && (d.save(), d.beginPath(), d.rect(18, b, t - 36, k), d.clip(), d.stroke(), d.fillStyle = h, null != r.name && d.fillText(r.name, 36, q + 0.7 * k), d.fillStyle = m, d.textAlign = "right", d.fillText(String(r.value).substr(0, 300), t - 36, q + 0.7 * k), d.restore());
          break;
        default:
          r.draw && r.draw(d, a, t, q, k);
      }
      b += (r.computeSize ? r.computeSize(t)[1] : k) + 4;
      d.globalAlpha = this.editor_alpha;
    }
    d.restore();
    d.textAlign = "left";
  ...
  l.prototype.processNodeWidgets = function(a, b, d, e) {
    ...
    for (var c = b[0] - a.pos[0], k = b[1] - a.pos[1], p = a.size[0], n = this, l = this.getCanvasWindow(), m = 0; m < a.widgets.length; ++m) {
      var h = a.widgets[m];
      if (h && !h.disabled) {
        var z = h.computeSize ? h.computeSize(p)[1] : f.NODE_WIDGET_HEIGHT, r = h.width || p;
        if (h == e || !(6 > c || c > r - 12 || k < h.last_y || k > h.last_y + z)) {
          e = h.value;
          switch(h.type) {
            case "button":
              if ("mousemove" === d.type) {
  ...
  l.prototype.showSearchBox = function(a) {
    ...
    g.search_box = n;
    var m = n.querySelector(".helper"), r = null, z = null, q = null, t = n.querySelector("input");
  ...
  B.prototype.draw = function(a, b, d, e, g, c) {
    if (d = this.points) {
      this.size = b;
...
(function(v) {
  ...
  e.GraphInput = m;
  e.registerNodeType("graph/input", m);
  h.title = "Output";
  ...
  e.GraphOutput = h;
  e.registerNodeType("graph/output", h);
  ...
  e.registerNodeType("basic/file", y);
  A.title = "Const Data";
  ...
  x.prototype.setValue = r.prototype.setValue;
  e.registerNodeType("basic/array", x);
  B.title = "Array[i]";
  ...
  C.title = "Object keys";
  C.desc = "Outputs an array with the keys of an object";
  C.prototype.onExecute = function() {
    var a = this.getInputData(0);
    null != a && this.setOutputData(0, Object.keys(a));
  };
  e.registerNodeType("basic/object_keys", C);
...
(function(v) {
  ...
  x.registerNodeType("events/trigger", q);
  m.title = "Sequencer";
  ...
  x.registerNodeType("events/branch", r);
  l.title = "Counter";
  ...
  x.registerNodeType("events/counter", l);
  D.title = "Delay";
  ...
  x.registerNodeType("events/delay", D);
  y.title = "Timer";
  y.desc = "Sends an event every N milliseconds";
  ...
  y.on_color = "#AAA";
  y.off_color = "#222";
  y.prototype.onDrawBackground = function() {
    this.boxcolor = this.triggered ? y.on_color : y.off_color;
    this.triggered = !1;
  };
  y.prototype.onExecute = function() {
    var c = 0 == this.time;
  ...
  x.registerNodeType("events/timer", y);
  A.title = "Data Store";
  ...
  x.registerNodeType("basic/data_store", A);
})(this);
(function(v) {
  function c() {
  ...
  m.prototype.onDrawForeground = function(c) {
    ...
    30 < h ? (c.fillStyle = m.markers_color, c.beginPath(), c.moveTo(f, 0.1 * h), c.lineTo(f + 0.1 * h, 0.2 * h), c.lineTo(f + -0.1 * h, 0.2 * h), c.fill(), c.beginPath(), c.moveTo(f, 0.9 * h), c.lineTo(f + 0.1 * h, 0.8 * h), c.lineTo(f + -0.1 * h, 0.8 * h), c.fill(), c.font = (0.7 * h).toFixed(1) + "px Arial") : c.font = (0.8 * h).toFixed(1) + "px Arial";
    c.textAlign = "center";
  ...
  m.prototype.onMouseMove = function(c) {
    if (this.mouse_captured) {
      ...
      c = this._remainder + f / m.pixels_threshold;
      this._remainder = c % 1;
  ...
  B.registerNodeType("widget/combo", h);
  r.title = "Knob";
  ...
  B.registerNodeType("widget/knob", r);
  ...
  B.registerNodeType("widget/progress", y);
  A.title = "Text";
  ...
  x.title = "Panel";
  x.desc = "Non interactive panel";
  x.widgets = [{name:"update", text:"Update", type:"button"}];
  x.prototype.createGradient = function(c) {
  ...
  B.registerNodeType("widget/panel", x);
})(this);
(function(v) {
  function c() {
...
(function(v) {
  ...
  u.registerNodeType("math/to_number", m);
  h.title = "Range";
  ...
  u.registerNodeType("math/range", h);
  r.title = "Rand";
  ...
  u.registerNodeType("math/clamp", y);
  A.title = "Lerp";
  ...
  u.registerNodeType("math/floor", B);
  f.title = "Frac";
  ...
  u.registerNodeType("math/scale", C);
  t.title = "Gate";
  ...
  u.registerNodeType("math3d/xy-to-vec2", G);
  F.title = "Vec3->XYZ";
  F.desc = "vector 3 to components";
  F.prototype.onExecute = function() {
    var a = this.getInputData(0);
    null != a && (this.setOutputData(0, a[0]), this.setOutputData(1, a[1]), this.setOutputData(2, a[2]));
  };
  u.registerNodeType("math3d/vec3-to-xyz", F);
  K.title = "XYZ->Vec3";
...
(function(v) {
  ...
  }, I.registerNodeType("texture/preview", q), m.title = "Save", m.desc = "Save a texture in the repository", m.prototype.getPreviewTexture = function() {
  ...
  }, I.registerNodeType("texture/save", m), h.widgets_info = {uvcode:{widget:"code"}, pixelcode:{widget:"code"}, precision:{widget:"combo", values:c.MODE_VALUES}}, h.title = "Operation", h.desc = "Texture shader operation", h.presets = {}, h.prototype.getExtraMenuOptions = function(a) {
    var b = this;
      ...
      if (this.properties.precision === c.PASS_THROUGH) {
        ...
        if (this.properties.uvcode || this.properties.pixelcode) {
          ...
          if (!(this.has_error || f && this._shader_code == g + "|" + k)) {
            var p = c.replaceCode(h.pixel_shader, {UV_CODE:g, PIXEL_CODE:k});
            try {
          ...
          if (this._shader) {
            ...
            this._tex.drawTo(function() {
              ...
              f.uniforms({u_texture:0, u_textureB:1, value:n, texSize:[d, e, 1 / d, 1 / e], time:l}).draw(c);
            });
  ...
  h.registerPreset("min", "min(color, colorB) * value"), h.registerPreset("displace", "texture2D(u_texture, uv + (colorB.xy - vec2(0.5)) * value).xyz"), h.registerPreset("grayscale", "vec3(color.x + color.y + color.z) * value / 3.0"), h.registerPreset("saturation", "mix( vec3(color.x + color.y + color.z) / 3.0, color, value )"), h.registerPreset("normalmap", "\n\t\tfloat z0 = texture2D(u_texture, uv + vec2(-texSize.z, -texSize.w) ).x;\n\t\tfloat z1 = texture2D(u_texture, uv + vec2(0.0, -texSize.w) ).x;\n\t\tfloat z2 = texture2D(u_texture, uv + vec2(texSize.z, -texSize.w) ).x;\n\t\tfloat z3 = texture2D(u_texture, uv + vec2(-texSize.z, 0.0) ).x;\n\t\tfloat z4 = color.x;\n\t\tfloat z5 = texture2D(u_texture, uv + vec2(texSize.z, 0.0) ).x;\n\t\tfloat z6 = texture2D(u_texture, uv + vec2(-texSize.z, texSize.w) ).x;\n\t\tfloat z7 = texture2D(u_texture, uv + vec2(0.0, texSize.w) ).x;\n\t\tfloat z8 = texture2D(u_texture, uv + vec2(texSize.z, texSize.w) ).x;\n\t\tvec3 normal = vec3( z2 + 2.0*z4 + z7 - z0 - 2.0*z3 - z5, z5 + 2.0*z6 + z7 -z0 - 2.0*z1 - z2, 1.0 );\n\t\tnormal.xy *= value;\n\t\tresult.xyz = normalize(normal) * 0.5 + vec3(0.5);\n\t"), 
  h.registerPreset("threshold", "vec3(color.x > colorB.x * value ? 1.0 : 0.0,color.y > colorB.y * value ? 1.0 : 0.0,color.z > colorB.z * value ? 1.0 : 0.0)"), h.prototype.onInspect = function(a) {
    var b = this;
    a.addCombo("Presets", "", {values:Object.keys(h.presets), callback:function(d) {
      var c = h.presets[d];
      c && (b.setProperty("pixelcode", c), b.title = d, a.refresh());
    }});
  }, I.registerNodeType("texture/operation", h), r.title = "Shader", r.desc = "Texture shader", r.widgets_info = {code:{type:"code", lang:"glsl"}, precision:{widget:"combo", values:c.MODE_VALUES}}, r.prototype.onPropertyChanged = function(a, b) {
  ...
  }, l.pixel_shader = "precision highp float;\n\t\t\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tvarying vec2 v_coord;\n\t\tuniform vec2 u_scale;\n\t\tuniform vec2 u_offset;\n\t\t\n\t\tvoid main() {\n\t\t\tvec2 uv = v_coord;\n\t\t\tuv = uv / u_scale - u_offset;\n\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t}\n\t\t", I.registerNodeType("texture/scaleOffset", l), D.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, D.title = "Warp", D.desc = "Texture warp operation", 
  D.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (this.isOutputConnected(0)) {
      if (this.properties.precision === c.PASS_THROUGH) {
  ...
  }, D.pixel_shader = "precision highp float;\n\t\t\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tvarying vec2 v_coord;\n\t\tuniform float u_factor;\n\t\tuniform vec2 u_scale;\n\t\tuniform vec2 u_offset;\n\t\t\n\t\tvoid main() {\n\t\t\tvec2 uv = v_coord;\n\t\t\tuv += ( texture2D(u_textureB, uv).rg - vec2(0.5)) * u_factor * u_scale + u_offset;\n\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t}\n\t\t", I.registerNodeType("texture/warp", D), y.title = "to Viewport", y.desc = 
  "Texture to viewport", y._prev_viewport = new Float32Array(4), y.prototype.onDrawBackground = function(a) {
  ...
  y.gamma_pixel_shader = "precision highp float;\n\t\tprecision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform float u_igamma;\n\t\tvoid main() {\n\t\t\tvec4 color = texture2D( u_texture, v_coord);\n\t\t\tcolor.xyz = pow(color.xyz, vec3(u_igamma) );\n\t\t   gl_FragColor = color;\n\t\t}\n\t\t", I.registerNodeType("texture/toviewport", y), A.title = "Copy", A.desc = "Copy Texture", A.widgets_info = {size:{widget:"combo", values:[0, 32, 64, 128, 256, 512, 1024, 
  ...
  }, I.registerNodeType("texture/copy", A), x.title = "Downsample", x.desc = "Downsample Texture", x.widgets_info = {iterations:{type:"number", step:1, precision:0, min:0}, precision:{widget:"combo", values:c.MODE_VALUES}}, x.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  I.registerNodeType("texture/downsample", x), B.title = "Resize", B.desc = "Resize Texture", B.widgets_info = {iterations:{type:"number", step:1, precision:0, min:0}, precision:{widget:"combo", values:c.MODE_VALUES}}, B.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if ((a || this._temp_texture) && this.isOutputConnected(0) && a && a.texture_type === GL.TEXTURE_2D) {
  ...
  }, I.registerNodeType("texture/resize", B), f.title = "Average", f.desc = "Compute a partial average (32 random samples) of a texture and stores it as a 1x1 pixel texture.\n If high_quality is true, then it generates the mipmaps first and reads from the lower one.", f.prototype.onExecute = function() {
  ...
  I.registerNodeType("texture/average", f), E.title = "Smooth", E.desc = "Smooth texture over time", E.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  }, E.pixel_shader = "precision highp float;\n\t\tprecision highp float;\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tuniform float u_factor;\n\t\tvarying vec2 v_coord;\n\t\t\n\t\tvoid main() {\n\t\t\tgl_FragColor = mix( texture2D( u_texture, v_coord ), texture2D( u_textureB, v_coord ), u_factor );\n\t\t}\n\t\t", I.registerNodeType("texture/temporal_smooth", E), C.title = "Lineal Avg Smooth", C.desc = "Smooth texture linearly over time", C["@samples"] = {type:"number", 
  min:1, max:64, step:1, precision:1}, C.prototype.getPreviewTexture = function() {
    ...
    if (a && this.isOutputConnected(0)) {
      ...
      if (0 == c || 0 == d % c) {
        ...
        var e = this._temp_texture, g = this._temp_texture2, k = C._shader_copy, f = C._shader_avg, p = this._uniforms;
        p.u_samples = b;
        p.u_isamples = 1.0 / b;
        gl.disable(gl.BLEND);
        gl.disable(gl.DEPTH_TEST);
  ...
  I.registerNodeType("texture/linear_avg_smooth", C), t.title = "Image to Texture", t.desc = "Uploads an image to the GPU", t.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a) {
  ...
  I.registerNodeType("texture/depth_range", g), w.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, w.title = "Linear Depth", w.desc = "Creates a color texture with linear depth", w.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
  ...
  I.registerNodeType("texture/linear_depth", w), G.title = "Blur", G.desc = "Blur a texture", G.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, G.max_iterations = 20, G.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
  ...
  }, I.registerNodeType("texture/blur", G), F.prototype.applyFX = function(a, b, d, c) {
    var e = a.width, g = a.height, k = {format:a.format, type:a.type, minFilter:GL.LINEAR, magFilter:GL.LINEAR, wrap:gl.CLAMP_TO_EDGE}, f = this._uniforms, p = this._textures, n = F._cut_shader;
    n || (n = F._cut_shader = new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER, F.cut_pixel_shader));
    gl.disable(gl.DEPTH_TEST);
    gl.disable(gl.BLEND);
    ...
    n = F._shader;
    n || (n = F._shader = new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER, F.scale_pixel_shader));
    for (var P = 1; P < m; P++) {
      e >>= 1;
      1 < (g | 0) && (g >>= 1);
      if (2 > e) {
    ...
    if (b) {
      ...
      f.u_intensity = q;
      n = t ? F._dirt_final_shader : F._final_shader;
      n || (n = t ? F._dirt_final_shader = new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER, F.final_pixel_shader, {USE_DIRT:""}) : F._final_shader = new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER, F.final_pixel_shader));
      b.drawTo(function() {
        a.bind(0);
        l.bind(1);
  ...
  }, I.registerNodeType("texture/webcam", u), z.title = "Lens FX", z.desc = "distortion and chromatic aberration", z.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, z.prototype.onGetInputs = function() {
    return [["enabled", "boolean"]];
  ...
  I.registerNodeType("texture/lensfx", z), T.title = "Data->Tex", T.desc = "Generates or applies a curve to a texture", T.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, T.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
      if (a) {
  ...
  }, I.registerNodeType("texture/fromdata", T), J.title = "Curve", J.desc = "Generates or applies a curve to a texture", J.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, J.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      ...
      if (a) {
        ...
        var e = J._shader;
        e || (e = J._shader = new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER, J.pixel_shader));
  ...
  I.registerNodeType("texture/curve", J), Q.title = "Exposition", Q.desc = "Controls texture exposition", Q.widgets_info = {exposition:{widget:"slider", min:0, max:3}, precision:{widget:"combo", values:c.MODE_VALUES}}, Q.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
      var b = this._temp_texture;
      b && b.width == a.width && b.height == a.height && b.type == a.type || (b = this._temp_texture = new GL.Texture(a.width, a.height, {type:a.type, format:gl.RGBA, filter:gl.LINEAR}));
...
(function(v) {
  ...
  if ("undefined" != typeof GL) {
    ...
    l.prototype.onExecute = function() {
      ...
      if (this.properties.precision === q.PASS_THROUGH) {
        ...
        if (c) {
          ...
          gl.disable(gl.BLEND);
          gl.disable(gl.DEPTH_TEST);
          var v = Mesh.getScreenQuad(), f = l._shader;
          this._tex.drawTo(function() {
            c.bind(0);
            f.uniforms({u_texture:0, u_aberration:h, u_distortion:m, u_blur:r}).draw(v);
          });
          this.setOutputData(0, this._tex);
        }
      }
    ...
    r.prototype.onExecute = function() {
      ...
      if (c && l && this.properties.shape) {
        ...
        if (m) {
          ...
          var C = r._second_shader;
          C || (C = r._second_shader = new GL.Shader(r._second_vertex_shader, r._second_pixel_shader));
          ...
          this._temp_texture.drawTo(function() {
            ...
            h.bind(1);
            l.bind(2);
            E.uniforms({u_texture:0, u_texture_blur:1, u_mask:2, u_texsize:[c.width, c.height]}).draw(H);
          });
          this._temp_texture.drawTo(function() {
            gl.enable(gl.BLEND);
            gl.blendFunc(gl.ONE, gl.ONE);
            c.bind(0);
            m.bind(3);
            C.uniforms({u_texture:0, u_mask:2, u_shape:3, u_alpha:n, u_threshold:v, u_pointSize:p, u_itexsize:[1.0 / c.width, 1.0 / c.height]}).draw(t, gl.POINTS);
          });
          this.setOutputData(0, this._temp_texture);
        }
      } else {
    ...
    r.prototype.createPointsMesh = function(c, h, l) {
      for (var m = Math.round(c / l), r = Math.round(h / l), f = new Float32Array(m * r * 2), q = -1, y = 2 / c * l, t = 2 / h * l, v = 0; v < r; ++v) {
      ...
      if (this.isOutputConnected(0)) {
        ...
        if (this.properties.precision === q.PASS_THROUGH) {
          ...
          if (c) {
            ...
            var r = this.properties.fx, B = h.shaders[r];
            if (!B) {
              var f = h["pixel_shader_" + r];
              if (!f) {
                return;
              }
              B = h.shaders[r] = new GL.Shader(Shader.SCREEN_VERTEX_SHADER, f);
            }
            gl.disable(gl.BLEND);
            gl.disable(gl.DEPTH_TEST);
            var E = Mesh.getScreenQuad();
...
(function(v) {
  ...
  q.prototype.openInputPort = function(f, n) {
  ...
  q.prototype.sendMIDI = function(f, n) {
    n && (f = this.output_ports_info[f]) && (q.output = this, n.constructor === c ? f.send(n.data) : f.send(n));
  };
  m.MIDIInterface = q;
  m.title = "MIDI Input";
  ...
  m.prototype.onMIDIEvent = function(f, h) {
  ...
  t.registerNodeType("midi/output", h);
  r.title = "MIDI Show";
  ...
  x.title = "MIDI Transpose";
  x.desc = "Transpose a MIDI note";
  x.color = "#243";
  x.prototype.onAction = function(f, h) {
  ...
  t.registerNodeType("midi/transpose", x);
  B.title = "MIDI Quantize Pitch";
  B.desc = "Transpose a MIDI note tp fit an scale";
  B.color = "#243";
  B.prototype.onPropertyChanged = function(c, f) {
  ...
  t.registerNodeType("midi/quantize", B);
  ...
  C.prototype.onMouseDown = function(f, h) {
    if (!(0 > h[1])) {
  ...
  C.prototype.onMouseMove = function(f, h) {
  ...
  C.prototype.onMouseUp = function(f, h) {
    if (!(0 > h[1])) {
  ...
  t.registerNodeType("midi/keys", C);
})(this);
(function(v) {
  function c() {
  ...
  p.registerNodeType("audio/analyser", m);
  h.prototype.onExecute = function() {
    if (this.inputs && this.inputs.length) {
  ...
  n.createAudioNodeWrapper(h);
  h.title = "Gain";
  h.desc = "Audio gain";
  p.registerNodeType("audio/gain", h);
  ...
  y.title = "Mixer";
  y.desc = "Audio mixer";
  p.registerNodeType("audio/mixer", y);
  A.prototype.onExecute = function() {
  ...
  x.title = "Delay";
  x.desc = "Audio delay";
  p.registerNodeType("audio/delay", x);
  B.prototype.onExecute = function() {
    if (this.inputs && this.inputs.length) {
      for (var c = 1; c < this.inputs.length; ++c) {
        var a = this.inputs[c];
  ...
  B.desc = "Audio filter";
  p.registerNodeType("audio/biquadfilter", B);
  ...
  p.registerNodeType("audio/signal", C);
