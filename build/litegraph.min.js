        ...
        if (!a.flags.collapsed) {
          if (a.inputs) {
            for (d = 0; d < a.inputs.length; d++) {
              ...
              b.beginPath();
              l.type === f.EVENT || l.shape === f.BOX_SHAPE ? p ? b.rect(u[0] - 5 + 0.5, u[1] - 8 + 0.5, 10, 14) : b.rect(u[0] - 6 + 0.5, u[1] - 5 + 0.5, 14, 10) : l.shape === f.ARROW_SHAPE ? (b.moveTo(u[0] + 8, u[1] + 0.5), b.lineTo(u[0] - 4, u[1] + 6 + 0.5), b.lineTo(u[0] - 4, u[1] - 6 + 0.5), b.closePath()) : g ? b.rect(u[0] - 4, u[1] - 4, 8, 8) : b.arc(u[0], u[1], 5, 0, 2 * Math.PI);
              b.fill();
              if (e) {
