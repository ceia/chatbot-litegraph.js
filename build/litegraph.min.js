  ...
  m.prototype.drawNodeShape = function(a, b, d, e, g, c, k) {
    ...
    if (u || n == f.TRANSPARENT_TITLE) {
      ...
      if (a.onDrawTitleBox) {
        ...
        x == f.ROUND_SHAPE || x == f.CIRCLE_SHAPE || x == f.CARD_SHAPE ? (p && (b.fillStyle = "black", b.beginPath(), b.arc(0.5 * g, -0.5 * g, 6, 0, 2 * Math.PI), b.fill()), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, p ? b.fillRect(0.5 * g - 5, -0.5 * g - 5, 10, 10) : (b.beginPath(), u = Math.sqrt(3) / 2 * 7.5, b.translate(0.5 * g, -0.5 * g), b.rotate(45), b.moveTo(0, -u / 2), b.lineTo(-3.75, u / 2), b.lineTo(3.75, u / 2), b.lineTo(0, -u / 2), b.stroke(), b.fill(), b.rotate(45), b.translate(-0.5 * 
