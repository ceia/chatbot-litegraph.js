...
(function(w) {
  ...
  h.prototype.computeSize = function(a) {
    ...
    if (this.widgets && this.widgets.length) {
      ...
      for (k = this.widgets.length; e < k; ++e) {
        b = this.widgets[e].computeSize ? b + (this.widgets[e].computeSize(a[0])[1] + 6) : b + (f.NODE_WIDGET_HEIGHT + 6);
      }
      b += 12;
    }
  ...
  l.prototype.drawNode = function(a, b) {
    ...
    if (this.live_mode) {
      ...
      b.globalAlpha = c;
      this.render_shadows && !g ? (b.shadowColor = a.selected ? "rgba(12,23,128,0.45)" : f.DEFAULT_SHADOW_COLOR, b.shadowOffsetX = 0 * this.ds.scale, b.shadowOffsetY = 1 * this.ds.scale, b.shadowBlur = 9 * this.ds.scale) : b.shadowColor = "transparent";
