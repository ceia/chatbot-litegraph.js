    ...
    if (a) {
      ...
      if (this.graph) {
        ...
        if (null != this.connecting_pos) {
          ...
          a.beginPath();
          this.connecting_output.type === f.EVENT || this.connecting_output.shape === f.BOX_SHAPE ? a.rect(this.connecting_pos[0] - 6 + 0.5, this.connecting_pos[1] - 5 + 0.5, 14, 10) : a.arc(this.connecting_pos[0], this.connecting_pos[1], 6, 0, 2 * Math.PI);
          a.fill();
          a.fillStyle = "#ffcc00";
  ...
  m.prototype.drawNodeShape = function(a, b, d, e, g, c, k) {
    ...
    if (v || n == f.TRANSPARENT_TITLE) {
      ...
      if (a.onDrawTitleBox) {
        ...
        x == f.ROUND_SHAPE || x == f.CIRCLE_SHAPE || x == f.CARD_SHAPE ? (p && (b.fillStyle = "black", b.beginPath(), b.arc(0.5 * g, -0.5 * g, 6, 0, 2 * Math.PI), b.fill()), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, p ? b.fillRect(0.5 * g - 5, -0.5 * g - 5, 10, 10) : (b.beginPath(), b.arc(0.5 * g, -0.5 * g, 5, 0, 2 * Math.PI), b.fill())) : (p && (b.fillStyle = "black", b.fillRect(0.5 * (g - 10) - 1, -0.5 * (g + 10) - 1, 12, 12)), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, b.fillRect(0.5 * 
        (g - 10), -0.5 * (g + 10), 10, 10));
      }
      b.globalAlpha = k;
