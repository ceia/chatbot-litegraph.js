    ...
    for (var n = f.WIDGET_OUTLINE_COLOR, l = f.WIDGET_BGCOLOR, m = f.WIDGET_TEXT_COLOR, h = f.WIDGET_SECONDARY_TEXT_COLOR, F = 0; F < c.length; ++F) {
      ...
      switch(r.type) {
        ...
        case "text":
          ...
          p ? d.roundRect(15, b, q - 30, k, 0.5 * k) : d.rect(15, b, q - 30, k);
          d.fill();
          p && (d.save(), d.beginPath(), d.rect(15, b, q - 30, k), d.clip(), d.stroke(), d.fillStyle = h, null != r.name && d.fillText(r.name, 30, I + 0.7 * k), d.fillStyle = m, d.textAlign = "right", d.fillText(String(r.value).substr(0, 30), q - 30, I + 0.7 * k), d.restore());
          break;
        default:
