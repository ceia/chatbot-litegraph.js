...
(function(w) {
        ...
        for (k = 0; k < n.outputs.length; k++) {
          if (a = n.outputs[k], null != a && null != a.links && 0 != a.links.length) {
            for (u = 0; u < a.links.length; u++) {
              (p = this.links[a.links[u]]) && !x[p.id] && (l = this.getNodeById(p.target_id), null == l ? x[p.id] = !0 : (b && (!l._level || l._level <= n._level) && (l._level = n._level + 1), x[p.id] = !0, --c[l.id], 0 == c[l.id] && e.push(l)));
            }
          }
        }
      }
  ...
  l.prototype.drawButton = function(a, b, d, e, g, c, k, p) {
    ...
    x.fill();
    null != g && g.constructor == String && (x.fillStyle = p, x.textAlign = "center", x.font = (0.65 * e | 0) + "px Arial", x.fillText(g, a + 0.5 * d, b + 0.75 * e), x.textAlign = "left");
        ...
        if (!a.flags.collapsed) {
          if (a.inputs) {
            for (d = 0; d < a.inputs.length; d++) {
              ...
              if (e) {
                ...
                F && (b.fillStyle = f.NODE_TEXT_COLOR, p || m.dir == f.UP ? b.fillText(F, u[0], u[1] - 10) : b.fillText(F, u[0] + 10, u[1] + 5));
              }
            }
          }
          ...
          if (a.outputs) {
            for (d = 0; d < a.outputs.length; d++) {
              ...
              m.shape === f.ARROW_SHAPE ? (b.moveTo(u[0] + 8, u[1] + 0.5), b.lineTo(u[0] - 4, u[1] + 6 + 0.5), b.lineTo(u[0] - 4, u[1] - 6 + 0.5), b.closePath()) : g ? b.rect(u[0] - 4, u[1] - 4, 8, 8) : b.arc(u[0], u[1], 6, 0, 2 * Math.PI), b.fill(), g || b.stroke(), e && (F = null != m.label ? m.label : m.name)) {
                b.fillStyle = f.NODE_TEXT_COLOR, p || m.dir == f.DOWN ? b.fillText(F, u[0], u[1] - 8) : b.fillText(F, u[0] - 10, u[1] + 5);
              }
            }
          }
          b.textAlign = "left";
  ...
  l.prototype.drawNodeShape = function(a, b, d, e, g, c, k) {
    ...
    var p = 0.5 > this.ds.scale, x = a._shape || a.constructor.shape || f.ROUND_SHAPE, n = a.constructor.title_mode, v = !0;
    ...
    if (v || n == f.TRANSPARENT_TITLE) {
      ...
      if (a.onDrawTitleBox) {
        ...
        x == f.ROUND_SHAPE || x == f.CIRCLE_SHAPE || x == f.CARD_SHAPE ? (p && (b.fillStyle = "black", b.beginPath(), b.arc(0.5 * g, -0.5 * g, 6, 0, 2 * Math.PI), b.fill()), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, p ? b.fillRect(0.5 * g - 5, -0.5 * g - 5, 10, 10) : (b.beginPath(), b.arc(0.5 * g, -0.5 * g, 2.5, 0, 2 * Math.PI), b.fill())) : (p && (b.fillStyle = "black", b.fillRect(0.5 * (g - 10) - 1, -0.5 * (g + 10) - 1, 12, 12)), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, b.fillRect(0.5 * 
        (g - 10), -0.5 * (g + 10), 10, 10));
      }
      b.globalAlpha = k;
          ...
          if (l && null != l.link && (l = this.graph.links[l.link])) {
            ...
            if (null != m) {
              ...
              if (A(p, G)) {
                var F = m.outputs[h];
                h = c.inputs[v];
                if (F && h && (m = F.dir || (m.horizontal ? f.DOWN : f.RIGHT), h = h.dir || (c.horizontal ? f.UP : f.LEFT), this.renderLink(a, r, u, l, !1, 0, null, m, h), l && l._last_time && 1000 > b - l._last_time)) {
                  F = 2.0 - 0.002 * (b - l._last_time);
                  var T = a.globalAlpha;
                  a.globalAlpha = T * F;
                  this.renderLink(a, r, u, l, !0, F, "white", m, h);
                  a.globalAlpha = T;
                }
              }
            }
  ...
  l.prototype.drawNodeWidgets = function(a, b, d, e) {
    ...
    for (var n = f.WIDGET_OUTLINE_COLOR, l = f.WIDGET_BGCOLOR, m = f.WIDGET_TEXT_COLOR, h = f.WIDGET_SECONDARY_TEXT_COLOR, F = 0; F < c.length; ++F) {
      var r = c[F], I = b;
      r.y && (I = r.y);
      r.last_y = I;
      d.strokeStyle = n;
      ...
      switch(r.type) {
        ...
        case "toggle":
          ...
          d.fill();
          p && (d.fillStyle = h, null != r.name && d.fillText(r.name, 30, I + 0.7 * k), d.fillStyle = r.value ? m : h, d.textAlign = "right", d.fillText(r.value ? r.options.on || "true" : r.options.off || "false", q - 40, I + 0.7 * k));
          break;
        case "slider":
          d.fillStyle = l;
        ...
        case "combo":
          ...
          p ? d.roundRect(15, b, q - 30, k, 0.5 * k) : d.rect(15, b, q - 30, k);
          d.fill();
          p && (r.disabled || d.stroke(), d.fillStyle = m, r.disabled || (d.beginPath(), d.moveTo(31, b + 5), d.lineTo(21, b + 0.5 * k), d.lineTo(31, b + k - 5), d.fill(), d.beginPath(), d.moveTo(q - 15 - 16, b + 5), d.lineTo(q - 15 - 6, b + 0.5 * k), d.lineTo(q - 15 - 16, b + k - 5), d.fill()), d.fillStyle = h, d.fillText(r.name, 35, I + 0.7 * k), d.fillStyle = m, d.textAlign = "right", "number" == r.type ? d.fillText(Number(r.value).toFixed(void 0 !== r.options.precision ? r.options.precision : 
        ...
        case "text":
          ...
          p ? d.roundRect(15, b, q - 30, k, 0.5 * k) : d.rect(15, b, q - 30, k);
          d.fill();
          p && (d.save(), d.beginPath(), d.rect(15, b, q - 30, k), d.clip(), d.stroke(), d.fillStyle = h, null != r.name && d.fillText(r.name, 30, I + 0.7 * k), d.fillStyle = m, d.textAlign = "right", d.fillText(String(r.value).substr(0, 300), q - 30, I + 0.7 * k), d.restore());
          break;
        default:
...
(function(w) {
  ...
  u.registerNodeType("math3d/vec2-to-xy", x);
  v.title = "XY->Vec2";
...
(function(w) {
  ...
  H.registerNodeType("texture/linear_depth", x), v.title = "Blur", v.desc = "Blur a texture", v.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, v.max_iterations = 20, v.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
