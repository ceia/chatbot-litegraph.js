...
(function(w) {
  ...
  ON_EVENT:1, NEVER:2, ON_TRIGGER:3, UP:1, DOWN:2, LEFT:3, RIGHT:4, CENTER:5, STRAIGHT_LINK:0, LINEAR_LINK:1, SPLINE_LINK:2, NORMAL_TITLE:0, NO_TITLE:1, TRANSPARENT_TITLE:2, AUTOHIDE_TITLE:3, proxy:null, node_images_path:"", debug:!1, catch_exceptions:!0, throw_errors:!0, allow_scripts:!1, registered_node_types:{}, node_types_by_file_extension:{}, Nodes:{}, Globals:{}, searchbox_extras:{}, registerNodeType:function(a, b) {
    ...
    if (e = this.registered_node_types[a]) {
      ...
      if (Object.hasOwnProperty(b.prototype, "shape") || Object.defineProperty(b.prototype, "shape", {set:function(a) {
        ...
        for (g in b.supported_extensions) {
          var y = b.supported_extensions[g];
          y && y.constructor === String && (this.node_types_by_file_extension[y.toLowerCase()] = b);
        }
      }
    }
    ...
    if (b.supported_extensions) {
      for (g = 0; g < b.supported_extensions.length; g++) {
        (y = b.supported_extensions[g]) && y.constructor === String && (this.node_types_by_file_extension[y.toLowerCase()] = b);
      }
    }
    ...
    for (var y = Array(b.length), c = "", k = f.getParameterNames(b), p = 0; p < k.length; ++p) {
  ...
  c.prototype.computeExecutionOrder = function(a, b) {
    for (var d = [], e = [], g = {}, y = {}, c = {}, k = 0, p = this._nodes.length; k < p; ++k) {
      var n = this._nodes[k];
      if (!a || n.onExecute) {
        g[n.id] = n;
        var l = 0;
        if (n.inputs) {
          for (var u = 0, A = n.inputs.length; u < A; u++) {
            n.inputs[u] && null != n.inputs[u].link && (l += 1);
          }
        }
        0 == l ? (e.push(n), b && (n._level = 1)) : (b && (n._level = 0), c[n.id] = l);
      }
    }
    for (; 0 != e.length;) {
        ...
        for (k = 0; k < n.outputs.length; k++) {
          if (a = n.outputs[k], null != a && null != a.links && 0 != a.links.length) {
            for (u = 0; u < a.links.length; u++) {
              (p = this.links[a.links[u]]) && !y[p.id] && (l = this.getNodeById(p.target_id), null == l ? y[p.id] = !0 : (b && (!l._level || l._level <= n._level) && (l._level = n._level + 1), y[p.id] = !0, --c[l.id], 0 == c[l.id] && e.push(l)));
            }
          }
        }
      }
  ...
  c.prototype.arrange = function(a) {
    ...
    for (e = 0; e < d.length; ++e) {
      if (y = d[e]) {
        for (var c = 100, k = a + f.NODE_TITLE_HEIGHT, p = 0; p < y.length; ++p) {
          g = y[p], g.pos[0] = b, g.pos[1] = k, g.size[0] > c && (c = g.size[0]), k += g.size[1] + a + f.NODE_TITLE_HEIGHT;
        }
        b += c + a;
      }
    }
  ...
  c.prototype.serialize = function() {
    ...
    for (b = 0; b < this._groups.length; ++b) {
      y.push(this._groups[b].serialize());
    }
    a = {last_node_id:this.last_node_id, last_link_id:this.last_link_id, nodes:a, links:d, groups:y, config:this.config, extra:this.extra, version:f.VERSION};
    if (this.onSerialize) {
      this.onSerialize(a);
    }
    return a;
    ...
    if (a) {
      ...
      if (b) {
        ...
        for (g = b.length; e < g; ++e) {
          y = b[e];
          var c = f.createNode(y.type, y.title);
          c || (f.debug && console.log("Node not found or has errors: " + y.type), c = new h, c.last_serialization = y, d = c.has_errors = !0);
          c.id = y.id;
          this.add(c, !0);
        }
        e = 0;
        for (g = b.length; e < g; ++e) {
          y = b[e], (c = this.getNodeById(y.id)) && c.configure(y);
        }
      }
  ...
  h.prototype.computeSize = function(a) {
    ...
    b = Math.max(b, 1);
    var d = 0, e = 0, g = this.getTitle ? this.getTitle() : this.title;
    g = g ? 7.6 * g.length + 40 : 0;
    this.horizontal && this.outputs && this.outputs.length && this.outputs.forEach(function(a) {
      d += 7.6 * (a.label || a.name || "").length + 15.2;
    });
    this.widgets && this.widgets.length && (this.widgets.forEach(function(a) {
      a = 7.6 * (a.name + a.value).length;
      e < a && (e = a);
    }), e += 60);
    a[0] = Math.ceil(Math.max(d, e, g));
    a[1] = (this.constructor.slot_start_y || 0) + b * f.NODE_SLOT_HEIGHT;
    b = 0;
    if (this.widgets && this.widgets.length) {
      g = 0;
      for (var c = this.widgets.length; g < c; ++g) {
        b = this.widgets[g].computeSize ? b + (this.widgets[g].computeSize(a[0])[1] + 8) : b + (f.NODE_WIDGET_HEIGHT + 8);
      }
      b = this.horizontal ? b + 16 : b + 2;
    }
              ...
              if (!g && !1 !== e.resizable && B(a.canvasX, a.canvasY, e.pos[0] + e.size[0] - 5, e.pos[1] + e.size[1] - 5, 10, 10)) {
                ...
                if (e.outputs) {
                  for (var k = 0, p = e.outputs.length; k < p; ++k) {
                    var n = e.outputs[k], m = e.getConnectionPos(!1, k);
                ...
                if (e.inputs) {
                  for (k = 0, p = e.inputs.length; k < p; ++k) {
                    if (n = e.inputs[k], m = e.getConnectionPos(!0, k), B(a.canvasX, a.canvasY, m[0] - 15, m[1] - 10, 30, 20)) {
                      if (c) {
  ...
  l.prototype.drawButton = function(a, b, d, e, g, c, k, p) {
    var y = this.ctx;
    ...
    v && (y.fillStyle = "#AAA");
    y.beginPath();
    y.roundRect(a, b, d, e, 4);
    y.fill();
    null != g && g.constructor == String && (y.fillStyle = p, y.textAlign = "center", y.font = (0.65 * e | 0) + "px Courier New", y.fillText(g, a + 0.5 * d, b + 0.75 * e), y.textAlign = "left");
    ...
    if (this.live_mode) {
      ...
      if (!a.flags.collapsed || !a.onDrawCollapsed || 1 != a.onDrawCollapsed(b, this)) {
        ...
        if (a.flags.collapsed) {
          ...
          null != n && (a._collapsed_width = Math.min(a.size[0], b.measureText(n).width + 2 * f.NODE_TITLE_HEIGHT), E[0] = a._collapsed_width, E[1] = 0);
        }
        ...
        if (!a.flags.collapsed) {
          if (a.inputs) {
            for (d = 0; d < a.inputs.length; d++) {
              ...
              var u = a.getConnectionPos(!0, d, l);
              u[0] -= a.pos[0];
              u[1] -= a.pos[1];
              n < u[1] + 0.5 * f.NODE_SLOT_HEIGHT && (n = u[1] + 0.5 * f.NODE_SLOT_HEIGHT);
              b.beginPath();
              m.type === f.EVENT || m.shape === f.BOX_SHAPE ? p ? b.rect(u[0] - 5 + 0.5, u[1] - 8 + 0.5, 10, 14) : b.rect(u[0] - 6 + 0.5, u[1] - 5 + 0.5, 14, 10) : m.shape === f.ARROW_SHAPE ? (b.moveTo(u[0] + 8, u[1] + 0.5), b.lineTo(u[0] - 4, u[1] + 6 + 0.5), b.lineTo(u[0] - 4, u[1] - 6 + 0.5), b.closePath()) : g ? b.rect(u[0] - 4, u[1] - 4, 8, 8) : b.arc(u[0], u[1], 6, 0, 2 * Math.PI);
              b.fill();
              if (e) {
                var A = null != m.label ? m.label : m.name;
                A && (b.fillStyle = f.NODE_TEXT_COLOR, p || m.dir == f.UP ? b.fillText(A, u[0], u[1] - 10) : b.fillText(A, u[0] + 10, u[1] + 5));
              }
            }
          }
          ...
          if (a.outputs) {
            for (d = 0; d < a.outputs.length; d++) {
              if (m = a.outputs[d], u = a.getConnectionPos(!1, d, l), u[0] -= a.pos[0], u[1] -= a.pos[1], n < u[1] + 0.5 * f.NODE_SLOT_HEIGHT && (n = u[1] + 0.5 * f.NODE_SLOT_HEIGHT), b.fillStyle = m.links && m.links.length ? m.color_on || this.default_connection_color.output_on : m.color_off || this.default_connection_color.output_off, b.beginPath(), m.type === f.EVENT || m.shape === f.BOX_SHAPE ? p ? b.rect(u[0] - 5 + 0.5, u[1] - 8 + 0.5, 10, 14) : b.rect(u[0] - 6 + 0.5, u[1] - 5 + 0.5, 14, 10) : 
              m.shape === f.ARROW_SHAPE ? (b.moveTo(u[0] + 8, u[1] + 0.5), b.lineTo(u[0] - 4, u[1] + 6 + 0.5), b.lineTo(u[0] - 4, u[1] - 6 + 0.5), b.closePath()) : g ? b.rect(u[0] - 4, u[1] - 4, 8, 8) : b.arc(u[0], u[1], 6, 0, 2 * Math.PI), b.fill(), g || b.stroke(), e && (A = null != m.label ? m.label : m.name)) {
                b.fillStyle = f.NODE_TEXT_COLOR, p || m.dir == f.DOWN ? b.fillText(A, u[0], u[1] - 8) : b.fillText(A, u[0] - 10, u[1] + 5);
              }
            }
          }
          b.textAlign = "left";
          ...
          if (this.render_collapsed_slots) {
            ...
            c && (c = 0, d = -0.5 * f.NODE_TITLE_HEIGHT, p && (c = 0.5 * a._collapsed_width, d = -f.NODE_TITLE_HEIGHT), b.fillStyle = "#7886ab", b.beginPath(), m.type === f.EVENT || m.shape === f.BOX_SHAPE ? b.rect(c - 7 + 0.5, d - 4, 14, 8) : m.shape === f.ARROW_SHAPE ? (b.moveTo(c + 8, d), b.lineTo(c + -4, d - 4), b.lineTo(c + -4, d + 4), b.closePath()) : b.arc(c, d, 6, 0, 2 * Math.PI), b.fill());
            g && (c = a._collapsed_width, d = -0.5 * f.NODE_TITLE_HEIGHT, p && (c = 0.5 * a._collapsed_width, d = 0), b.fillStyle = "#8295a1", b.strokeStyle = "white", b.beginPath(), m.type === f.EVENT || m.shape === f.BOX_SHAPE ? b.rect(c - 7 + 0.5, d - 4, 14, 8) : m.shape === f.ARROW_SHAPE ? (b.moveTo(c + 6, d), b.lineTo(c - 6, d - 4), b.lineTo(c - 6, d + 4), b.closePath()) : b.arc(c, d, 6, 0, 2 * Math.PI), b.fill());
          }
        }
  ...
  l.prototype.drawNodeShape = function(a, b, d, e, g, c, k) {
    ...
    var y = 0.5 > this.ds.scale, p = a._shape || a.constructor.shape || f.ROUND_SHAPE, n = a.constructor.title_mode, v = !0;
    ...
    k = b.globalAlpha;
    b.beginPath();
    p == f.BOX_SHAPE || y ? b.fillRect(t[0], t[1], t[2], t[3]) : p == f.ROUND_SHAPE || p == f.CARD_SHAPE ? b.roundRect(t[0], t[1], t[2], t[3], this.round_radius, p == f.CARD_SHAPE ? 0 : this.round_radius) : p == f.CIRCLE_SHAPE && b.arc(0.5 * d[0], 0.5 * d[1], 0.5 * d[0], 0, 2 * Math.PI);
    b.fill();
    ...
    if (v || n == f.TRANSPARENT_TITLE) {
      if (a.onDrawTitleBar) {
        ...
        if (n != f.TRANSPARENT_TITLE && (a.constructor.title_color || this.render_title_colored)) {
          ...
          if (this.use_gradients) {
            var m = l.gradients[v];
            m || (m = l.gradients[v] = b.createLinearGradient(0, 0, 400, 0), m.addColorStop(0, v), m.addColorStop(1, "#000"));
            b.fillStyle = m;
          } else {
            b.fillStyle = v;
          }
          b.beginPath();
          p == f.BOX_SHAPE || y ? b.rect(0, -g, d[0] + 1, g) : (p == f.ROUND_SHAPE || p == f.CARD_SHAPE) && b.roundRect(0, -g, d[0] + 1, g, this.round_radius, a.flags.collapsed ? this.round_radius : 0);
          b.fill();
          b.shadowColor = "transparent";
        }
      }
      if (a.onDrawTitleBox) {
        ...
        p == f.ROUND_SHAPE || p == f.CIRCLE_SHAPE || p == f.CARD_SHAPE ? (y && (b.fillStyle = "black", b.beginPath(), b.arc(0.5 * g, -0.5 * g, 6, 0, 2 * Math.PI), b.fill()), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, y ? b.fillRect(0.5 * g - 5, -0.5 * g - 5, 10, 10) : (b.beginPath(), v = Math.sqrt(3) / 2 * 7.5, b.translate(0.5 * g, -0.5 * g), a.flags.collapsed ? b.rotate(90 * Math.PI / 180) : b.rotate(180 * Math.PI / 180), b.moveTo(0, -v / 2), b.lineTo(-3.75, v / 2), b.lineTo(3.75, v / 
        2), b.lineTo(0, -v / 2), b.stroke(), b.fill(), a.flags.collapsed ? b.rotate(-90 * Math.PI / 180) : b.rotate(-180 * Math.PI / 180), b.translate(-0.5 * g, 0.5 * g), b.closePath())) : (y && (b.fillStyle = "black", b.fillRect(0.5 * (g - 10) - 1, -0.5 * (g + 10) - 1, 12, 12)), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, b.fillRect(0.5 * (g - 10), -0.5 * (g + 10), 10, 10));
      }
      b.globalAlpha = k;
      if (a.onDrawTitleText) {
        a.onDrawTitleText(b, g, d, this.ds.scale, this.title_text_font, c);
      }
      !y && (b.font = this.title_text_font, k = String(a.getTitle())) && (b.fillStyle = c ? f.NODE_SELECTED_TITLE_COLOR : a.constructor.title_text_color || this.node_title_color, a.flags.collapsed ? (b.textAlign = "left", b.measureText(k), b.fillText(k.substr(0, 20), g, f.NODE_TITLE_TEXT_Y - g), b.textAlign = "left") : (b.textAlign = "left", b.fillText(k, g, f.NODE_TITLE_TEXT_Y - g)));
      a.flags.collapsed || !a.subgraph || a.skip_subgraph_button || (k = f.NODE_TITLE_HEIGHT, v = a.size[0] - k, m = f.isInsideRectangle(this.graph_mouse[0] - a.pos[0], this.graph_mouse[1] - a.pos[1], v + 2, -k + 2, k - 4, k - 4), b.fillStyle = m ? "#888" : "#555", p == f.BOX_SHAPE || y ? b.fillRect(v + 2, -k + 2, k - 4, k - 4) : (b.beginPath(), b.roundRect(v + 2, -k + 2, k - 4, k - 4, 4), b.fill()), b.fillStyle = "#333", b.beginPath(), b.moveTo(v + 0.2 * k, 0.6 * -k), b.lineTo(v + 0.8 * k, 0.6 * 
    ...
    if (c) {
      ...
      b.globalAlpha = 0.8;
      b.beginPath();
      p == f.BOX_SHAPE ? b.rect(-6 + t[0], -6 + t[1], 12 + t[2], 12 + t[3]) : p == f.ROUND_SHAPE || p == f.CARD_SHAPE && a.flags.collapsed ? b.roundRect(-6 + t[0], -6 + t[1], 12 + t[2], 12 + t[3], 2 * this.round_radius) : p == f.CARD_SHAPE ? b.roundRect(-6 + t[0], -6 + t[1], 12 + t[2], 12 + t[3], 2 * this.round_radius, 2) : p == f.CIRCLE_SHAPE && b.arc(0.5 * d[0], 0.5 * d[1], 0.5 * d[0] + 6, 0, 2 * Math.PI);
  ...
  var H = new Float32Array(4), p = new Float32Array(4), n = new Float32Array(2), k = new Float32Array(2);
      ...
      if (c.inputs && c.inputs.length) {
        for (var v = 0; v < c.inputs.length; ++v) {
          ...
          if (l && null != l.link && (l = this.graph.links[l.link])) {
            ...
            if (null != m) {
              var h = l.origin_slot;
              var r = -1 == h ? [m.pos[0] + 10, m.pos[1] + 10] : m.getConnectionPos(!1, h, n);
              ...
              if (C(p, H)) {
                var A = m.outputs[h];
                h = c.inputs[v];
                if (A && h && (m = A.dir || (m.horizontal ? f.DOWN : f.RIGHT), h = h.dir || (c.horizontal ? f.UP : f.LEFT), this.renderLink(a, r, u, l, !1, 0, null, m, h), l && l._last_time && 1000 > b - l._last_time)) {
                  A = 2.0 - 0.002 * (b - l._last_time);
                  var q = a.globalAlpha;
                  a.globalAlpha = q * A;
                  this.renderLink(a, r, u, l, !0, A, "white", m, h);
                  a.globalAlpha = q;
                }
              }
            }
  ...
  l.prototype.renderLink = function(a, b, d, e, g, c, k, p, n, m) {
    ...
    for (var v = 0; v < m; v += 1) {
      ...
      if (this.links_render_mode == f.SPLINE_LINK) {
        ...
        a.bezierCurveTo(b[0] + h, b[1] + x + A, d[0] + J, d[1] + r + A, d[0], d[1] + A);
      } else {
        if (this.links_render_mode == f.LINEAR_LINK) {
          ...
          a.lineTo(b[0] + 15 * h, b[1] + 15 * x + A);
          a.lineTo(d[0] + 15 * J, d[1] + 15 * r + A);
          a.lineTo(d[0], d[1] + A);
        } else {
          if (this.links_render_mode == f.STRAIGHT_LINK) {
            a.moveTo(b[0], b[1]), A = b[0], h = b[1], x = d[0], J = d[1], p == f.RIGHT ? A += 10 : h += 10, n == f.LEFT ? x -= 10 : J -= 10, a.lineTo(A, h), a.lineTo(0.5 * (A + x), h), a.lineTo(0.5 * (A + x), J), a.lineTo(x, J), a.lineTo(d[0], d[1]);
          } else {
            return;
          }
        }
    ...
    0.6 <= this.ds.scale && this.highquality_render && n != f.CENTER && this.render_connection_arrows && (v = this.computeConnectionPoint(b, d, 0.25, p, n), m = this.computeConnectionPoint(b, d, 0.26, p, n), e = this.computeConnectionPoint(b, d, 0.75, p, n), g = this.computeConnectionPoint(b, d, 0.76, p, n), this.render_curved_connections ? (m = -Math.atan2(m[0] - v[0], m[1] - v[1]), g = -Math.atan2(g[0] - e[0], g[1] - e[1])) : g = m = d[1] > b[1] ? 0 : Math.PI, a.save(), a.translate(v[0], v[1]), 
  ...
  l.prototype.computeConnectionPoint = function(a, b, d, e, g) {
    e = e || f.RIGHT;
    g = g || f.LEFT;
    var c = F(a, b), k = [a[0], a[1]], p = [b[0], b[1]];
    switch(e) {
      case f.LEFT:
        k[0] += -0.25 * c;
        break;
  ...
  l.prototype.drawNodeWidgets = function(a, b, d, e) {
    ...
    var n = f.WIDGET_OUTLINE_COLOR, l = a.color || f.WIDGET_BGCOLOR, m = f.WIDGET_TEXT_COLOR, h = f.WIDGET_SECONDARY_TEXT_COLOR, A = 18;
    a.horizontal && (A = 8);
    for (var r = 0; r < c.length; ++r) {
      ...
      d.fillStyle = l;
      d.textAlign = "left";
      x.disabled && (d.globalAlpha *= 0.5);
      var t = x.width || g;
      switch(x.type) {
        case "button":
          x.clicked && (d.fillStyle = "#AAA", x.clicked = !1, this.dirty_canvas = !0);
          d.fillStyle = f.WIDGET_BGCOLOR;
          d.fillRect(3 * A, q, t - 6 * A, k);
          p && !x.disabled && d.strokeRect(A, q, t - 2 * A, k);
          p && (d.textAlign = "center", d.font = "italic 12px Courier New", d.fillStyle = m, d.fillText(x.name, 0.5 * t, q + 0.7 * k), d.font = "normal 12px Courier New");
          d.fillStyle = l;
          break;
        case "toggle":
          d.textAlign = "left";
          ...
          d.fillStyle = l;
          d.beginPath();
          p ? d.roundRect(A, b, t - 2 * A, k, 0.5 * k) : d.rect(A, b, t - 2 * A, k);
          d.fill();
          p && !x.disabled && d.stroke();
          d.fillStyle = x.value ? "#89A" : "#333";
          d.beginPath();
          d.arc(t - 2 * A, q + 0.5 * k, 0.36 * k, 0, 2 * Math.PI);
          d.fill();
          p && (d.fillStyle = h, null != x.name && d.fillText(x.name, 2 * A, q + 0.7 * k), d.fillStyle = x.value ? m : h, d.textAlign = "right", d.fillText(x.value ? x.options.on || "true" : x.options.off || "false", t - 40, q + 0.7 * k));
          break;
        case "slider":
          d.fillStyle = l;
          d.fillRect(A, q, t - 2 * A, k);
          var G = x.options.max - x.options.min, D = (x.value - x.options.min) / G;
          d.fillStyle = e == x ? "#89A" : "#678";
          d.fillRect(A, q, D * (t - 2 * A), k);
          p && !x.disabled && d.strokeRect(A, q, t - 2 * A, k);
          x.marker && (G = (x.marker - x.options.min) / G, d.fillStyle = "#AA9", d.fillRect(A + G * (t - 2 * A), q, 2, k));
          p && (d.textAlign = "center", d.fillStyle = m, d.fillText(x.name + "  " + Number(x.value).toFixed(3), 0.5 * t, q + 0.7 * k));
          break;
        case "number":
        case "combo":
          d.textAlign = "left";
          ...
          p ? d.roundRect(A, b, t - 2 * A, k, 0.5 * k) : d.rect(A, b, t - 2 * A, k);
          d.fill();
          p && (x.disabled || d.stroke(), d.fillStyle = m, x.disabled || (d.beginPath(), d.moveTo(A + 16, b + 5), d.lineTo(A + 6, b + 0.5 * k), d.lineTo(A + 16, b + k - 5), d.fill(), d.beginPath(), d.moveTo(t - A - 16, b + 5), d.lineTo(t - A - 6, b + 0.5 * k), d.lineTo(t - A - 16, b + k - 5), d.fill()), d.fillStyle = h, d.fillText(x.name, 2 * A + 5, q + 0.7 * k), d.fillStyle = m, d.textAlign = "right", "number" == x.type ? d.fillText(Number(x.value).toFixed(void 0 !== x.options.precision ? x.options.precision : 
          3), t - 2 * A - 20, q + 0.7 * k) : (G = x.value, x.options.values && (D = x.options.values, D.constructor === Function && (D = D()), D && D.constructor !== Array && (G = D[x.value])), d.fillText(G, t - 2 * A - 20, q + 0.7 * k)));
          break;
        case "string":
        case "text":
          d.textAlign = "left";
          ...
          d.fillStyle = l;
          d.beginPath();
          p ? d.roundRect(A, b, t - 2 * A, k, 0.125 * k) : d.rect(A, b, t - 2 * A, k);
          d.fill();
          p && (d.save(), d.beginPath(), d.rect(A, b, t - 2 * A, k), d.clip(), d.stroke(), d.fillStyle = h, null != x.name && d.fillText(x.name, 2 * A, q + 0.7 * k), d.fillStyle = m, d.textAlign = "right", d.fillText(String(x.value).substr(0, 300), t - 2 * A, q + 0.7 * k), d.restore());
          break;
        default:
          x.draw && x.draw(d, a, t, q, k);
      }
      b += (x.computeSize ? x.computeSize(t)[1] : k) + 6;
      d.globalAlpha = this.editor_alpha;
    }
    d.restore();
    d.textAlign = "left";
  ...
  l.prototype.processNodeWidgets = function(a, b, d, e) {
    ...
    for (var c = b[0] - a.pos[0], k = b[1] - a.pos[1], p = a.size[0], n = this, l = this.getCanvasWindow(), m = 0; m < a.widgets.length; ++m) {
      var h = a.widgets[m];
      if (h && !h.disabled) {
        var A = h.computeSize ? h.computeSize(p)[1] : f.NODE_WIDGET_HEIGHT, r = h.width || p;
          ...
          switch(h.type) {
            ...
            case "combo":
              ...
              if ("mousemove" == d.type && "number" == h.type) {
                ...
                if ("mousedown" == d.type) {
                  var x = h.options.values;
                  x && x.constructor === Function && (x = h.options.values(h, a));
                  var q = null;
                  "number" != h.type && (q = x.constructor === Array ? x : Object.keys(x));
                  c = 40 > c ? -1 : c > r - 40 ? 1 : 0;
                  if ("number" == h.type) {
                    ...
                    if (c) {
                      l = -1, this.last_mouseclick = 0, l = x.constructor === Object ? q.indexOf(String(h.value)) + c : q.indexOf(h.value) + c, l >= q.length && (l = q.length - 1), 0 > l && (l = 0), h.value = x.constructor === Array ? x[l] : l;
                    } else {
                      var t = x != q ? Object.values(x) : x;
  ...
  l.onMenuAdd = function(a, b, d, e, g) {
    ...
    var k = l.active_canvas, p = k.getCanvasWindow(), n = k.graph;
    if (n) {
  ...
  l.prototype.showLinkMenu = function(a, b) {
    var d = this, e = new f.ContextMenu(["Add Node", null, "Delete"], {event:b, title:null != a.data ? a.data.constructor.name : null, callback:function(b, c, f) {
      switch(b) {
        case "Add Node":
  ...
  l.prototype.showSearchBox = function(a) {
        ...
        if (g.onSearchBox) {
          ...
          for (k in f.searchbox_extras) {
            ...
            if (-1 !== h.desc.toLowerCase().indexOf(d)) {
              ...
              if (!P || P.filter == n) {
                if (a(h.desc, "searchbox_extra"), -1 !== l.search_limit && p++ > l.search_limit) {
                  break;
                }
              }
            }
          ...
          for (k = 0; k < h.length && !(a(h[k]), -1 !== l.search_limit && p++ > l.search_limit); k++) {
          }
        }
      }
    }
    var g = this, c = l.active_canvas, k = c.canvas, p = k.ownerDocument || document, n = document.createElement("div");
    ...
    g.search_box = n;
    var m = n.querySelector(".helper"), r = null, A = null, q = null, x = n.querySelector("input");
    ...
    e.addWidget = function(a, b, c, k, p) {
      ...
      if ("boolean" == a) {
        ...
        if ("string" == a || "number" == a) {
          ...
          if ("enum" == a || "combo" == a) {
            n = l.getPropertyPrintableValue(c, k.values);
          }
        }
      }
      m.innerText = n;
...
(function(w) {
  ...
  u.registerNodeType("math/range", m);
  r.title = "Rand";
  ...
  u.registerNodeType("math/noise", l);
  F.title = "Spikes";
  ...
  u.registerNodeType("math/spikes", F);
  B.title = "Clamp";
  ...
  u.registerNodeType("math/clamp", B);
  C.title = "Lerp";
  ...
  u.registerNodeType("math/lerp", C);
  z.title = "Abs";
  z.desc = "Absolute";
  z.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  u.registerNodeType("math/floor", D);
  f.title = "Frac";
  ...
  u.registerNodeType("math/smoothstep", G);
  E.title = "Scale";
  E.desc = "v * factor";
  E.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  u.registerNodeType("math/scale", E);
  t.title = "Gate";
  ...
  u.registerNodeType("math/average", H);
  p.title = "TendTo";
...
(function(w) {
      ...
      if (this.properties.precision === c.PASS_THROUGH) {
        ...
        if (this.properties.uvcode || this.properties.pixelcode) {
          ...
          if (!(this.has_error || f && this._shader_code == g + "|" + k)) {
            var p = c.replaceCode(m.pixel_shader, {UV_CODE:g, PIXEL_CODE:k});
            try {
  ...
  min:1, max:64, step:1, precision:1}, E.prototype.getPreviewTexture = function() {
    ...
    if (a && this.isOutputConnected(0)) {
      ...
      if (0 == c || 0 == d % c) {
        ...
        var e = this._temp_texture, g = this._temp_texture2, k = E._shader_copy, f = E._shader_avg, p = this._uniforms;
        p.u_samples = b;
        p.u_isamples = 1.0 / b;
        gl.disable(gl.BLEND);
        gl.disable(gl.DEPTH_TEST);
  ...
  I.registerNodeType("texture/LUT", H), p.widgets_info = {texture:{widget:"texture"}, precision:{widget:"combo", values:c.MODE_VALUES}}, p.title = "Encode", p.desc = "Apply a texture atlas to encode a texture", p.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
      if (this.properties.precision === c.PASS_THROUGH || !1 === this.properties.enabled) {
        this.setOutputData(0, a);
  ...
  I.registerNodeType("texture/encode", p), n.title = "Texture to Channels", n.desc = "Split texture channels", n.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a) {
  ...
  }, n.pixel_shader = "precision highp float;\n\t\tprecision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform vec4 u_mask;\n\t\t\n\t\tvoid main() {\n\t\t   gl_FragColor = vec4( vec3( length( texture2D(u_texture, v_coord) * u_mask )), 1.0 );\n\t\t}\n\t\t", I.registerNodeType("texture/textureChannels", n), k.title = "Channels to Texture", k.desc = "Split texture channels", k.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, k.prototype.onExecute = 
  function() {
  ...
  I.registerNodeType("texture/depth_range", g), y.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, y.title = "Linear Depth", y.desc = "Creates a color texture with linear depth", y.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
      if (a && (a.format == gl.DEPTH_COMPONENT || a.format == gl.DEPTH_STENCIL)) {
        ...
        gl.disable(gl.DEPTH_TEST);
        var e = Mesh.getScreenQuad();
        y._shader || (y._shader = new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER, y.pixel_shader));
        var g = y._shader;
        b = null;
        b = a.near_far_planes ? a.near_far_planes : window.LS && LS.Renderer._main_camera ? LS.Renderer._main_camera._uniforms.u_camera_planes : [0.1, 1000];
        d.u_camera_planes = b;
  ...
  I.registerNodeType("texture/linear_depth", y), v.title = "Blur", v.desc = "Blur a texture", v.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, v.max_iterations = 20, v.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
  ...
  }, I.registerNodeType("texture/blur", v), J.prototype.applyFX = function(a, b, d, c) {
    ...
    c && (q[0] = 1 / l.width, q[1] = 1 / l.height, f.u_intensity = r, f.u_delta = 1, l.blit(c, n.uniforms(f)));
    gl.enable(gl.BLEND);
    gl.blendFunc(gl.ONE, gl.ONE);
    f.u_intensity = this.persistence;
    f.u_delta = 0.5;
    for (P -= 2; 0 <= P; P--) {
      h = p[P], p[P] = null, q[0] = 1 / l.width, q[1] = 1 / l.height, l.blit(h, n.uniforms(f)), GL.Texture.releaseTemporary(l), l = h;
    }
    gl.disable(gl.BLEND);
    d && l.blit(d);
    if (b) {
  ...
  I.registerNodeType("texture/xDoG", M), u.title = "Webcam", u.desc = "Webcam texture", u.is_webcam_open = !1, u.prototype.openStream = function() {
  ...
  }, I.registerNodeType("texture/webcam", u), A.title = "Lens FX", A.desc = "distortion and chromatic aberration", A.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, A.prototype.onGetInputs = function() {
    return [["enabled", "boolean"]];
  }, A.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
  ...
  I.registerNodeType("texture/lensfx", A), T.title = "Data->Tex", T.desc = "Generates or applies a curve to a texture", T.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, T.prototype.onExecute = function() {
  ...
  }, I.registerNodeType("texture/fromdata", T), x.title = "Curve", x.desc = "Generates or applies a curve to a texture", x.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, x.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      ...
      if (a) {
        ...
        var e = x._shader;
        e || (e = x._shader = new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER, x.pixel_shader));
  ...
  }, x.prototype.sampleCurve = function(a, b) {
  ...
  }, x.prototype.updateCurve = function() {
    ...
    if (!this.flags.collapsed) {
      ...
      this.properties.split_channels ? ("RGB" == d && (this.widgets[1].value = d = "R", this.widgets[1].disabled = !1), this.curve_editor.points = this._points.R, this.curve_editor.draw(a, [this.size[0], this.size[1] - this.curve_offset], b, "#111", x.channel_line_colors.R, !0), a.globalCompositeOperation = "lighten", this.curve_editor.points = this._points.G, this.curve_editor.draw(a, [this.size[0], this.size[1] - this.curve_offset], b, null, x.channel_line_colors.G, !0), this.curve_editor.points = 
      this._points.B, this.curve_editor.draw(a, [this.size[0], this.size[1] - this.curve_offset], b, null, x.channel_line_colors.B, !0), a.globalCompositeOperation = "source-over") : (this.widgets[1].value = d = "RGB", this.widgets[1].disabled = !0);
      this.curve_editor.points = this._points[d];
      this.curve_editor.draw(a, [this.size[0], this.size[1] - this.curve_offset], b, this.properties.split_channels ? null : "#111", x.channel_line_colors[d]);
      a.restore();
    }
  }, x.pixel_shader = "precision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_curve;\n\t\tuniform float u_range;\n\t\t\n\t\tvoid main() {\n\t\t\tvec4 color = texture2D( u_texture, v_coord ) * u_range;\n\t\t\tcolor.x = texture2D( u_curve, vec2( color.x, 0.5 ) ).x;\n\t\t\tcolor.y = texture2D( u_curve, vec2( color.y, 0.5 ) ).y;\n\t\t\tcolor.z = texture2D( u_curve, vec2( color.z, 0.5 ) ).z;\n\t\t\t//color.w = texture2D( u_curve, vec2( color.w, 0.5 ) ).w;\n\t\t\tgl_FragColor = color;\n\t\t}", 
  I.registerNodeType("texture/curve", x), Q.title = "Exposition", Q.desc = "Controls texture exposition", Q.widgets_info = {exposition:{widget:"slider", min:0, max:3}, precision:{widget:"combo", values:c.MODE_VALUES}}, Q.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
      var b = this._temp_texture;
      b && b.width == a.width && b.height == a.height && b.type == a.type || (b = this._temp_texture = new GL.Texture(a.width, a.height, {type:a.type, format:gl.RGBA, filter:gl.LINEAR}));
    ...
    r.prototype.onExecute = function() {
      ...
      if (c && l && this.properties.shape) {
        ...
        if (m) {
          ...
          var H = Mesh.getScreenQuad(), p = this.properties.size, n = this.properties.alpha;
          gl.disable(gl.DEPTH_TEST);
          gl.disable(gl.BLEND);
          this._temp_texture.drawTo(function() {
            c.bind(0);
          ...
          this._temp_texture.drawTo(function() {
            ...
            c.bind(0);
            m.bind(3);
            E.uniforms({u_texture:0, u_mask:2, u_shape:3, u_alpha:n, u_threshold:w, u_pointSize:p, u_itexsize:[1.0 / c.width, 1.0 / c.height]}).draw(t, gl.POINTS);
          });
          this.setOutputData(0, this._temp_texture);
        }
      } else {
...
(function(w) {
  ...
  m.title = "Gain";
  m.desc = "Audio gain";
  p.registerNodeType("audio/gain", m);
  ...
  p.registerNodeType("audio/dynamicsCompressor", l);
  F.prototype.onExecute = function() {
    if (this.inputs && this.inputs.length) {
      var c = this.getInputData(1);
  ...
  B.title = "Mixer";
  B.desc = "Audio mixer";
  p.registerNodeType("audio/mixer", B);
  C.prototype.onExecute = function() {
  ...
  p.registerNodeType("audio/adsr", C);
  ...
  z.title = "Delay";
  z.desc = "Audio delay";
  p.registerNodeType("audio/delay", z);
  D.prototype.onExecute = function() {
    if (this.inputs && this.inputs.length) {
      for (var c = 1; c < this.inputs.length; ++c) {
        var a = this.inputs[c];
  ...
  D.desc = "Audio filter";
  p.registerNodeType("audio/biquadfilter", D);
  ...
  p.registerNodeType("audio/visualization", G);
  E.prototype.onExecute = function() {
  ...
  p.registerNodeType("audio/signal", E);
  ...
  H.title = "Destination";
  H.desc = "Audio output";
  p.registerNodeType("audio/destination", H);
})(this);
(function(w) {
  function c() {
    this.size = [60, 20];
