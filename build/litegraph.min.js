...
(function(w) {
  ...
  h.prototype.computeSize = function(a) {
    if (this.constructor.size) {
      return console.log(this.constructor.size), this.constructor.size.concat();
    }
    var b = Math.max(this.inputs ? this.inputs.length : 1, this.outputs ? this.outputs.length : 1);
    a = a || new Float32Array([0, 0]);
    console.log(a);
    b = Math.max(b, 1);
    var d = 0, e = 0, g = this.title ? 7.6 * this.title.length + 40 : 0;
    ...
    a[1] = this.horizontal ? a[1] + 10 : a[1] + 4;
    return a;
  };
