...
(function(w) {
        ...
        for (k = 0; k < n.outputs.length; k++) {
          if (a = n.outputs[k], null != a && null != a.links && 0 != a.links.length) {
            for (u = 0; u < a.links.length; u++) {
              (p = this.links[a.links[u]]) && !x[p.id] && (m = this.getNodeById(p.target_id), null == m ? x[p.id] = !0 : (b && (!m._level || m._level <= n._level) && (m._level = n._level + 1), x[p.id] = !0, --c[m.id], 0 == c[m.id] && e.push(m)));
            }
          }
        }
      }
        ...
        if (!a.flags.collapsed) {
          if (a.inputs) {
            for (d = 0; d < a.inputs.length; d++) {
              ...
              b.beginPath();
              l.type === f.EVENT || l.shape === f.BOX_SHAPE ? p ? b.rect(u[0] - 5 + 0.5, u[1] - 8 + 0.5, 10, 14) : b.rect(u[0] - 6 + 0.5, u[1] - 5 + 0.5, 14, 10) : l.shape === f.ARROW_SHAPE ? (b.moveTo(u[0] + 8, u[1] + 0.5), b.lineTo(u[0] - 4, u[1] + 6 + 0.5), b.lineTo(u[0] - 4, u[1] - 6 + 0.5), b.closePath()) : g ? b.rect(u[0] - 4, u[1] - 4, 8, 8) : b.arc(u[0], u[1], 6, 0, 2 * Math.PI);
              b.fill();
              if (e) {
          ...
          if (a.outputs) {
            for (d = 0; d < a.outputs.length; d++) {
              ...
              l.shape === f.ARROW_SHAPE ? (b.moveTo(u[0] + 8, u[1] + 0.5), b.lineTo(u[0] - 4, u[1] + 6 + 0.5), b.lineTo(u[0] - 4, u[1] - 6 + 0.5), b.closePath()) : g ? b.rect(u[0] - 4, u[1] - 4, 8, 8) : b.arc(u[0], u[1], 6, 0, 2 * Math.PI), b.fill(), g || b.stroke(), e && (F = null != l.label ? l.label : l.name)) {
  ...
  m.prototype.renderLink = function(a, b, d, e, g, c, k, p, n, l) {
    ...
    0.6 <= this.ds.scale && this.highquality_render && n != f.CENTER && this.render_connection_arrows && (v = this.computeConnectionPoint(b, d, 0.25, p, n), l = this.computeConnectionPoint(b, d, 0.26, p, n), e = this.computeConnectionPoint(b, d, 0.75, p, n), g = this.computeConnectionPoint(b, d, 0.76, p, n), this.render_curved_connections ? (l = -Math.atan2(l[0] - v[0], l[1] - v[1]), g = -Math.atan2(g[0] - e[0], g[1] - e[1])) : g = l = d[1] > b[1] ? 0 : Math.PI, a.save(), a.translate(v[0], v[1]), 
