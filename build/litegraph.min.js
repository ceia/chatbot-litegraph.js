...
(function(w) {
  ...
  c.prototype.computeExecutionOrder = function(a, b) {
    for (var d = [], e = [], g = {}, x = {}, c = {}, k = 0, n = this._nodes.length; k < n; ++k) {
      ...
      if (!a || p.onExecute) {
        ...
        var l = 0;
        if (p.inputs) {
          for (var v = 0, F = p.inputs.length; v < F; v++) {
              ...
              if (!g && !1 !== e.resizable && z(a.canvasX, a.canvasY, e.pos[0] + e.size[0] - 5, e.pos[1] + e.size[1] - 5, 10, 10)) {
                ...
                if (e.outputs) {
                  for (var k = 0, n = e.outputs.length; k < n; ++k) {
                    ...
                    if (z(a.canvasX, a.canvasY, m[0] - 15, m[1] - 10, 30, 20)) {
                ...
                if (e.inputs) {
                  for (k = 0, n = e.inputs.length; k < n; ++k) {
                    if (p = e.inputs[k], m = e.getConnectionPos(!0, k), z(a.canvasX, a.canvasY, m[0] - 15, m[1] - 10, 30, 20)) {
                      if (c) {
    ...
    if (this.live_mode) {
      ...
      if (!a.flags.collapsed || !a.onDrawCollapsed || 1 != a.onDrawCollapsed(b, this)) {
        ...
        if (a.flags.collapsed) {
          ...
          null != p && (a._collapsed_width = Math.min(a.size[0], b.measureText(p).width + 2 * f.NODE_TITLE_HEIGHT), B[0] = a._collapsed_width, B[1] = 0);
        }
        ...
        if (!a.flags.collapsed) {
          if (a.inputs) {
            for (d = 0; d < a.inputs.length; d++) {
              ...
              b.fill();
              if (e) {
                var F = null != m.label ? m.label : m.name;
                F && (b.fillStyle = f.NODE_TEXT_COLOR, n || m.dir == f.UP ? b.fillText(F, v[0], v[1] - 10) : b.fillText(F, v[0] + 10, v[1] + 5));
              }
            }
          }
          ...
          if (a.outputs) {
            for (d = 0; d < a.outputs.length; d++) {
              ...
              m.shape === f.ARROW_SHAPE ? (b.moveTo(v[0] + 8, v[1] + 0.5), b.lineTo(v[0] - 4, v[1] + 6 + 0.5), b.lineTo(v[0] - 4, v[1] - 6 + 0.5), b.closePath()) : g ? b.rect(v[0] - 4, v[1] - 4, 8, 8) : b.arc(v[0], v[1], 6, 0, 2 * Math.PI), b.fill(), g || b.stroke(), e && (F = null != m.label ? m.label : m.name)) {
                b.fillStyle = f.NODE_TEXT_COLOR, n || m.dir == f.DOWN ? b.fillText(F, v[0], v[1] - 8) : b.fillText(F, v[0] - 10, v[1] + 5);
              }
            }
          }
          b.textAlign = "left";
          ...
          if (l && null != l.link && (l = this.graph.links[l.link])) {
            ...
            if (null != m) {
              ...
              if (A(n, G)) {
                var F = m.outputs[h];
                h = c.inputs[u];
                if (F && h && (m = F.dir || (m.horizontal ? f.DOWN : f.RIGHT), h = h.dir || (c.horizontal ? f.UP : f.LEFT), this.renderLink(a, r, v, l, !1, 0, null, m, h), l && l._last_time && 1000 > b - l._last_time)) {
                  F = 2.0 - 0.002 * (b - l._last_time);
                  var T = a.globalAlpha;
                  a.globalAlpha = T * F;
                  this.renderLink(a, r, v, l, !0, F, "white", m, h);
                  a.globalAlpha = T;
                }
              }
            }
      ...
      if (this.links_render_mode == f.SPLINE_LINK) {
        ...
        if (this.links_render_mode == f.LINEAR_LINK) {
          ...
          if (this.links_render_mode == f.STRAIGHT_LINK) {
            a.moveTo(b[0], b[1]), F = b[0], h = b[1], J = d[0], r = d[1], n == f.RIGHT ? F += 10 : h += 10, p == f.LEFT ? J -= 10 : r -= 10, a.lineTo(F, h), a.lineTo(0.5 * (F + J), h), a.lineTo(0.5 * (F + J), r), a.lineTo(J, r), a.lineTo(d[0], d[1]);
          } else {
            return;
          }
        }
  ...
  l.prototype.computeConnectionPoint = function(a, b, d, e, g) {
    e = e || f.RIGHT;
    g = g || f.LEFT;
    var c = D(a, b), k = [a[0], a[1]], n = [b[0], b[1]];
    switch(e) {
      case f.LEFT:
        k[0] += -0.25 * c;
        break;
  ...
  l.prototype.drawNodeWidgets = function(a, b, d, e) {
    ...
    for (var p = f.WIDGET_OUTLINE_COLOR, l = a.color || f.WIDGET_BGCOLOR, m = f.WIDGET_TEXT_COLOR, h = f.WIDGET_SECONDARY_TEXT_COLOR, F = 0; F < c.length; ++F) {
      var r = c[F], I = b;
      r.y && (I = r.y);
      r.last_y = I;
      d.strokeStyle = p;
      ...
      switch(r.type) {
        case "button":
          ...
          d.fillRect(54, I, q - 108, k);
          n && !r.disabled && d.strokeRect(18, I, q - 36, k);
          n && (d.textAlign = "center", d.font = "italic 12px Courier New", d.fillStyle = m, d.fillText(r.name, 0.5 * q, I + 0.7 * k), d.font = "normal 12px Courier New");
          d.fillStyle = l;
          break;
        case "toggle":
          d.textAlign = "left";
          ...
          d.fillStyle = l;
          d.beginPath();
          n ? d.roundRect(18, b, q - 36, k, 0.5 * k) : d.rect(18, b, q - 36, k);
          d.fill();
          n && !r.disabled && d.stroke();
          d.fillStyle = r.value ? "#89A" : "#333";
          d.beginPath();
          d.arc(q - 36, I + 0.5 * k, 0.36 * k, 0, 2 * Math.PI);
          d.fill();
          n && (d.fillStyle = h, null != r.name && d.fillText(r.name, 36, I + 0.7 * k), d.fillStyle = r.value ? m : h, d.textAlign = "right", d.fillText(r.value ? r.options.on || "true" : r.options.off || "false", q - 40, I + 0.7 * k));
          break;
        case "slider":
          d.fillStyle = l;
          d.fillRect(18, I, q - 36, k);
          var t = r.options.max - r.options.min, E = (r.value - r.options.min) / t;
          d.fillStyle = e == r ? "#89A" : "#678";
          d.fillRect(18, I, E * (q - 36), k);
          n && !r.disabled && d.strokeRect(18, I, q - 36, k);
          r.marker && (t = (r.marker - r.options.min) / t, d.fillStyle = "#AA9", d.fillRect(18 + t * (q - 36), I, 2, k));
          n && (d.textAlign = "center", d.fillStyle = m, d.fillText(r.name + "  " + Number(r.value).toFixed(3), 0.5 * q, I + 0.7 * k));
          break;
        case "number":
        case "combo":
          d.textAlign = "left";
          ...
          n ? d.roundRect(18, b, q - 36, k, 0.5 * k) : d.rect(18, b, q - 36, k);
          d.fill();
          n && (r.disabled || d.stroke(), d.fillStyle = m, r.disabled || (d.beginPath(), d.moveTo(34, b + 5), d.lineTo(24, b + 0.5 * k), d.lineTo(34, b + k - 5), d.fill(), d.beginPath(), d.moveTo(q - 18 - 16, b + 5), d.lineTo(q - 18 - 6, b + 0.5 * k), d.lineTo(q - 18 - 16, b + k - 5), d.fill()), d.fillStyle = h, d.fillText(r.name, 41, I + 0.7 * k), d.fillStyle = m, d.textAlign = "right", "number" == r.type ? d.fillText(Number(r.value).toFixed(void 0 !== r.options.precision ? r.options.precision : 
          3), q - 36 - 20, I + 0.7 * k) : (t = r.value, r.options.values && (E = r.options.values, E.constructor === Function && (E = E()), E && E.constructor !== Array && (t = E[r.value])), d.fillText(t, q - 36 - 20, I + 0.7 * k)));
          break;
        case "string":
        case "text":
          d.textAlign = "left";
          ...
          d.fillStyle = l;
          d.beginPath();
          n ? d.roundRect(18, b, q - 36, k, 0.125 * k) : d.rect(18, b, q - 36, k);
          d.fill();
          n && (d.save(), d.beginPath(), d.rect(18, b, q - 36, k), d.clip(), d.stroke(), d.fillStyle = h, null != r.name && d.fillText(r.name, 36, I + 0.7 * k), d.fillStyle = m, d.textAlign = "right", d.fillText(String(r.value).substr(0, 300), q - 36, I + 0.7 * k), d.restore());
          break;
        default:
          r.draw && r.draw(d, a, q, I, k);
      }
      b += (r.computeSize ? r.computeSize(q)[1] : k) + 6;
      d.globalAlpha = this.editor_alpha;
    }
    d.restore();
    d.textAlign = "left";
  ...
  l.prototype.processNodeWidgets = function(a, b, d, e) {
    ...
    for (var c = b[0] - a.pos[0], k = b[1] - a.pos[1], n = a.size[0], p = this, l = this.getCanvasWindow(), m = 0; m < a.widgets.length; ++m) {
      var h = a.widgets[m];
      if (h && !h.disabled) {
        var F = h.computeSize ? h.computeSize(n)[1] : f.NODE_WIDGET_HEIGHT, r = h.width || n;
              ...
              if ("mousemove" == d.type && "number" == h.type) {
                ...
                if ("mousedown" == d.type) {
                  ...
                  if ("number" == h.type) {
                    ...
                    if (c) {
                      l = -1, this.last_mouseclick = 0, l = q.constructor === Object ? t.indexOf(String(h.value)) + c : t.indexOf(h.value) + c, l >= t.length && (l = t.length - 1), 0 > l && (l = 0), h.value = q.constructor === Array ? q[l] : l;
                    } else {
  ...
  l.prototype.showSearchBox = function(a) {
    ...
    g.search_box = p;
    var m = p.querySelector(".helper"), r = null, F = null, q = null, t = p.querySelector("input");
...
(function(w) {
  ...
  y.registerNodeType("events/filter", m);
  r.title = "Branch";
...
(function(w) {
  ...
  C.registerNodeType("widget/combo", m);
  r.title = "Knob";
...
(function(w) {
  ...
  v.registerNodeType("math/spikes", D);
  z.title = "Clamp";
  ...
  v.registerNodeType("math/clamp", z);
  A.title = "Lerp";
  ...
  v.registerNodeType("math/lerp", A);
  y.title = "Abs";
  y.desc = "Absolute";
  y.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  v.registerNodeType("math/scale", B);
  t.title = "Gate";
  ...
  v.registerNodeType("math/average", G);
  n.title = "TendTo";
...
(function(w) {
  ...
  var H = w.LiteGraph, Y = w.LGraphCanvas;
  ...
  }, H.registerNodeType("texture/save", h), m.widgets_info = {uvcode:{widget:"code"}, pixelcode:{widget:"code"}, precision:{widget:"combo", values:c.MODE_VALUES}}, m.title = "Operation", m.desc = "Texture shader operation", m.presets = {}, m.prototype.getExtraMenuOptions = function(a) {
    var b = this;
  ...
  }, H.registerNodeType("texture/operation", m), r.title = "Shader", r.desc = "Texture shader", r.widgets_info = {code:{type:"code", lang:"glsl"}, precision:{widget:"combo", values:c.MODE_VALUES}}, r.prototype.onPropertyChanged = function(a, b) {
  ...
  }, r.pixel_shader = "precision highp float;\n\nvarying vec2 v_coord;\nuniform float time; //time in seconds\nuniform vec4 texSize; //tex resolution\nuniform float u_value;\nuniform vec4 u_color;\n\nvoid main() {\n\tvec2 uv = v_coord;\n\tvec3 color = vec3(0.0);\n\t//your code here\n\tcolor.xy=uv;\n\n\tgl_FragColor = vec4(color, 1.0);\n}\n", H.registerNodeType("texture/shader", r), l.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, l.title = "Scale/Offset", l.desc = "Applies an scaling and offseting", 
  l.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  min:1, max:64, step:1, precision:1}, B.prototype.getPreviewTexture = function() {
    ...
    if (a && this.isOutputConnected(0)) {
      ...
      if (0 == c || 0 == d % c) {
        ...
        var e = this._temp_texture, g = this._temp_texture2, k = B._shader_copy, f = B._shader_avg, n = this._uniforms;
        n.u_samples = b;
        n.u_isamples = 1.0 / b;
        gl.disable(gl.BLEND);
        gl.disable(gl.DEPTH_TEST);
  ...
  H.registerNodeType("texture/LUT", G), n.widgets_info = {texture:{widget:"texture"}, precision:{widget:"combo", values:c.MODE_VALUES}}, n.title = "Encode", n.desc = "Apply a texture atlas to encode a texture", n.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
      if (this.properties.precision === c.PASS_THROUGH || !1 === this.properties.enabled) {
        this.setOutputData(0, a);
  ...
  H.registerNodeType("texture/encode", n), p.title = "Texture to Channels", p.desc = "Split texture channels", p.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a) {
  ...
  }, p.pixel_shader = "precision highp float;\n\t\tprecision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform vec4 u_mask;\n\t\t\n\t\tvoid main() {\n\t\t   gl_FragColor = vec4( vec3( length( texture2D(u_texture, v_coord) * u_mask )), 1.0 );\n\t\t}\n\t\t", H.registerNodeType("texture/textureChannels", p), k.title = "Channels to Texture", k.desc = "Split texture channels", k.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, k.prototype.onExecute = 
  function() {
  ...
  H.registerNodeType("texture/depth_range", g), x.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, x.title = "Linear Depth", x.desc = "Creates a color texture with linear depth", x.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
  ...
  H.registerNodeType("texture/linear_depth", x), u.title = "Blur", u.desc = "Blur a texture", u.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, u.max_iterations = 20, u.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
  ...
  }, H.registerNodeType("texture/blur", u), J.prototype.applyFX = function(a, b, d, c) {
    ...
    c && (r[0] = 1 / l.width, r[1] = 1 / l.height, f.u_intensity = q, f.u_delta = 1, l.blit(c, p.uniforms(f)));
    gl.enable(gl.BLEND);
    gl.blendFunc(gl.ONE, gl.ONE);
    f.u_intensity = this.persistence;
    f.u_delta = 0.5;
    for (P -= 2; 0 <= P; P--) {
      h = n[P], n[P] = null, r[0] = 1 / l.width, r[1] = 1 / l.height, l.blit(h, p.uniforms(f)), GL.Texture.releaseTemporary(l), l = h;
    }
    gl.disable(gl.BLEND);
    d && l.blit(d);
    if (b) {
  ...
  H.registerNodeType("texture/xDoG", M), v.title = "Webcam", v.desc = "Webcam texture", v.is_webcam_open = !1, v.prototype.openStream = function() {
  ...
  }, H.registerNodeType("texture/webcam", v), F.title = "Lens FX", F.desc = "distortion and chromatic aberration", F.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, F.prototype.onGetInputs = function() {
    return [["enabled", "boolean"]];
  }, F.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
...
(function(w) {
  ...
  if ("undefined" != typeof GL) {
    ...
    r.prototype.onExecute = function() {
      ...
      if (c && l && this.properties.shape) {
        ...
        if (m) {
          ...
          var G = Mesh.getScreenQuad(), n = this.properties.size, p = this.properties.alpha;
          gl.disable(gl.DEPTH_TEST);
          gl.disable(gl.BLEND);
          this._temp_texture.drawTo(function() {
            c.bind(0);
          ...
          this._temp_texture.drawTo(function() {
            ...
            c.bind(0);
            m.bind(3);
            B.uniforms({u_texture:0, u_mask:2, u_shape:3, u_alpha:p, u_threshold:w, u_pointSize:n, u_itexsize:[1.0 / c.width, 1.0 / c.height]}).draw(t, gl.POINTS);
          });
          this.setOutputData(0, this._temp_texture);
        }
      } else {
    ...
    r.prototype.createPointsMesh = function(c, h, l) {
      for (var m = Math.round(c / l), r = Math.round(h / l), f = new Float32Array(m * r * 2), q = -1, z = 2 / c * l, t = 2 / h * l, w = 0; w < r; ++w) {
      ...
      if (this.isOutputConnected(0)) {
        ...
        if (this.properties.precision === q.PASS_THROUGH) {
          ...
          if (c) {
            ...
            var r = this.properties.fx, C = m.shaders[r];
            if (!C) {
              var f = m["pixel_shader_" + r];
              if (!f) {
                return;
              }
              C = m.shaders[r] = new GL.Shader(Shader.SCREEN_VERTEX_SHADER, f);
            }
            gl.disable(gl.BLEND);
            gl.disable(gl.DEPTH_TEST);
            var E = Mesh.getScreenQuad();
            var B = w.LS && LS.Renderer._current_camera ? [LS.Renderer._current_camera.near, LS.Renderer._current_camera.far] : [1, 100];
            var t = null;
            "noise" == r && (t = q.getNoiseTexture());
            this._tex.drawTo(function() {
              c.bind(0);
              "noise" == r && t.bind(1);
              C.uniforms({u_texture:0, u_noise:1, u_size:[c.width, c.height], u_rand:[Math.random(), Math.random()], u_value1:h, u_value2:l, u_camera_planes:B}).draw(E);
            });
            this.setOutputData(0, this._tex);
          }
        }
...
(function(w) {
  ...
  C.desc = "Audio filter";
  n.registerNodeType("audio/biquadfilter", C);
  ...
  n.registerNodeType("audio/signal", B);
        ...
        if (null != l) {
          ...
          if (l.length && l.constructor !== String) {
            if (this._last_sent_data[h]) {
              for (this._last_sent_data[h].length = l.length, A = 0; A < l.length; ++A) {
                this._last_sent_data[h][A] = l[A];
              }
            } else {
