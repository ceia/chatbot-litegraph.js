...
(function(w) {
  ...
  l.prototype.drawNode = function(a, b) {
    ...
    if (this.live_mode) {
      ...
      b.globalAlpha = c;
      this.render_shadows && !g ? (b.shadowColor = f.DEFAULT_SHADOW_COLOR, b.shadowOffsetX = 3 * this.ds.scale, b.shadowOffsetY = 3 * this.ds.scale, b.shadowBlur = 6 * this.ds.scale) : b.shadowColor = "transparent";
